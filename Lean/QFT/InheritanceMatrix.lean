  ...
  [{ index := 1
   ...
   { index := 4
     ...
     citation := "Gated by design on B14 (#705, current/holonomy), \
       ...
       character lattice); none has a module in the tree." },
   { index := 5
