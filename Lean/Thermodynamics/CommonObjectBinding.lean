...
refinement control therefore remain source-side obligations under #739.  The
physical inverse-temperature reading and energy-clock calibration are the
separate empirical import PR-15.
-/
