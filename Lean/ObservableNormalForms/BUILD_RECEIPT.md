...
Windows could not materialize all generated Lean filenames below the canonical
R4 worktree because that absolute path exceeds the platform path limit. The two
