...
pixel. Lean checks the contraction theorem that gives existence and uniqueness,
...
\(137.035660136946577\ldots\). The CODATA value is used only to test these
...
The pixel map carries zero continuous dials. Lean checks the fixed-point
existence and uniqueness theorem used by the calculation, and each declared
map has a machine-certified unique fixed point: the source map contracts to
...
(runtime artifact
\texttt{p\_global\_uniqueness\_extension\_certificate\_2026-07-17.json}).
