...
(interval contraction certificate of 2026-07-14, shipped with the code release \cite{oph-code}).
...
existing and unique on its interval (interval certificate of 2026-07-14,
...
(ledger row CL-6, closed 2026-07-14; the printed-pair identity is pinned by a
...
and its OpenTimestamps proofs are committed together in the public
repository, so the freeze date is verifiable
...
interval. The interval contraction certificate of 2026-07-14, shipped with
...
exceptional set
(domain-global uniqueness certificate of 2026-07-14, in the same release), so
