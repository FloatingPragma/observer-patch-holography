...
hadronic spectral transport; this construction consumes that transport as a
premise and does not compute it.
\end{abstract}
...
QCD step, and a clear boundary between a source theorem, empirical endpoint
input, and measured comparison.
...
Informally: the endpoint number is the same number NIST/CODATA reports. The derivation exposes every OPH-side step and identifies where the low-energy hadronic calculation enters. That hadronic spectral calculation is the named premise separating this endpoint display from a source theorem.
