...
(ledger row CL-6, closed 2026-07-14; CI test
\texttt{code/P\_derivation/test\_printed\_pair\_identity.py}). The remaining
...
SL-3 basin, rows CL-1 and CL-2). The global at-most-one statement on the full
physical domain additionally requires monotonicity of \(\ATh\) in \(P\), which
remains an open analytic item.
...
Interval theorem & Banach/contraction certificate for full \(G\) & Discharged for the declared numerical map (2026-07-14 certificate, both readout modes); still required for the full source map with the hadronic term. \\
\bottomrule
\end{longtable}
...
(enclosure width \(7.2\times10^{-24}\), certificate of 2026-07-14).
