...
imports these fourteen modules alongside the wider OPH event-algebra library.

The checked development contributes fourteen pieces:
...
(Section~\ref{sec:phase-determination}); and
...
trace preserving; the fourteen-module audit here covers their event-algebra
...
phase-POVM/count-fit model and its synthetic non-discharge control.
...
Table~\ref{tab:modules} lists the fourteen source modules. The comparison in
...
fourteen-module count and scale table.
...
Table~\ref{tab:scale} describes the fourteen modules discussed here and the
