...
CHSH interface. We compare it with Mathlib, Physlib, Lean-Quantum,
...
bound remain outside the formalization.
\end{abstract}
...
trace. The raw function still covers the zero-weight case; the state theorem
...
\textbf{Use of generative AI.} Generative-AI tools were used for draft text,
proof suggestions, and code review. Bernhard Mueller reviewed the manuscript
and ran the submitted Lean project. He takes responsibility for the text and
source. The pinned Lean kernel checked every accepted proof.
