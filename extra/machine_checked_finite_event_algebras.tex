...
Clauser--Horne--Shimony--Holt bound for projection events. The artifact pins
its Lean and Mathlib revisions and records declaration-level axiom
dependencies. Complete positivity, a Physlib correspondence, rank-one
classicality, and a sharpness witness lie outside the formalization.
\end{abstract}
