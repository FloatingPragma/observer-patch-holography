...
The module \texttt{LuedersPhaseInstrument} types the PR-64 channel clauses as a
...
declared selection, no source implements it, and PR-64, PR-65, and PR-03 are
open. The module is a companion in the wider library, outside the
fifteen-module count and scale table.
