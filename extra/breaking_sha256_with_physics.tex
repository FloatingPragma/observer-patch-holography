...
\InputIfFileExists{../paper/release_info}{}{%
  \newcommand{\OPHPaperReleaseID}{r1455}
...
\cite{OPHConsensusCurrent}. Here is the SHA-256d version.
...
is the Planck length \cite{OPHCompactCurrent,OPHScreenCurrent}. In the public OPH
