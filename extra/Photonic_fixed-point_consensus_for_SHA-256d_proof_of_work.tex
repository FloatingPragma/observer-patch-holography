...
verifier-ready candidate. The proposed SHA-256d test architecture is
OMEGA-I1, a five-chamber, host-routed optical federation with duplicate torus
recurrence, search-torus expansion, asymmetric criticism, Echosahedron
...
digital verification, and a separate shuffle-replay audit reported
\(\widehat\beta(12)=2{,}434\) on the Kaspa chord-promote output. Here
\(\widehat\beta(12)\) is the exact-verifier hit rate for candidates with at
least \(12\) leading zero bits divided by the uniform-random baseline \(2^{-12}\);
the reported value means that the selected candidate stream hit that \(12\)-bit
target \(2{,}434\) times as often as uniform random nonces. This is used as
controlled candidate-enrichment evidence. The present paper contributes the OPH
constraint formalism and SHA-256d scorebook.
...
high-\(k\) shoulder rather than only at easy targets.
