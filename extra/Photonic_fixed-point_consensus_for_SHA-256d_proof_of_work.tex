...
instead of \(2^{-12}\). Feeding this number into the prospective throughput
formula presumes a per-event bias that has not been measured: the datum is a
post-selection acceptance property, and prospective per-event enrichment is
unestablished. It also does not by itself determine SHA-256d speedup,
