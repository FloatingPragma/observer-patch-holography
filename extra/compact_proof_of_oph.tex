...
Higgs mass chart, the strong-interaction scale, cosmic capacity closure,
...
Each pair is read on the strictest target-free branch its sector supports.
The weak-boson pair follows the strict source-audit branch: the zero-selector
law on the target-free branch, with no measured mass entering. The Higgs and
top pair follows the double-criticality branch, where both Yukawa-sector
boundaries derive from the gauge sector through \(\lambda=0\),
\(\beta_\lambda=0\) at one source scale, a zero-continuous-parameter family
whose adopted member is the frozen post-exposure boundary-scale candidate
\(E_\star e^{-\pi}P^{-1/6}\), evaluated at two loops [O5,C4]:
\[
\begin{array}{rcl}
(m_W,m_Z)_{\rm OPH} &=& (80.330,\,91.119)\,\mathrm{GeV},\\
(m_H,m_t)_{\rm OPH} &=& (125.77,\,172.63)\,\mathrm{GeV}.
\end{array}
\]
...
premises; its finite carrier certificate (QT1--QT5) and the source-law
selection principle deciding the one discrete two-law choice (ambiguity
\(9.3\)~MeV on \(M_W\), \(5.1\)~MeV on \(M_Z\)) are work in progress, so these
are conditional coordinates, not physical complex-pole masses. The Higgs/top
boundary scale is a theorem modulo two finite carrier facts: the criticality
law fixes the whole family from the gauge sector, the log-midpoint selection
principle is proved with its quadratic-cost and placement premises reduced to
the axioms, and the two remaining facts, the boundary record's two parent ports
and the equal register class of its anchors, are the same D11 census the
\(W/Z\) law already needs; the three-loop implied scale is the registered
discriminating test. Along the fit-free criticality
curve the Higgs coordinate at the measured top mass is \(125.72\)~GeV
(\(+0.47\) percent), a relation test independent of the boundary-scale
selection.
...
\((m_W,m_Z)=(80.330,91.119)\,\mathrm{GeV}\) within \(10^{-3}\) of measurement
with no measured mass entering; the double-criticality branch gives
\((m_H,m_t)=(125.77,172.63)\,\mathrm{GeV}\) at the frozen boundary-scale
candidate. No promoted complex-pole mass. &
Strict source-audit branch + criticality family & 5\\
...
Strict source-audit branch + criticality family &
The strict source-audit branch gives \((m_W,m_Z)=(80.330,91.119)\,\mathrm{GeV}\)
within \(10^{-3}\) of measurement with no fitted mass; the double-criticality
branch gives \((m_H,m_t)=(125.77,172.63)\,\mathrm{GeV}\) at the frozen
boundary-scale candidate, with \(m_H=125.72\)~GeV on the fit-free curve at the
measured top. No promoted complex-pole mass. &
5 / C4\\
...
measurement, with the criticality Higgs/top pair inside the declared matching
band & one chance in one thousand & \(10^{-3}\)\\
