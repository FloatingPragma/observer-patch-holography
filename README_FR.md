...
- **[Theoretical Bounds on $\chi_\nu$ in Observer-Patch Holography](extra/chi_nu_susceptibility_bounds.pdf)** : bornes OPH de la fenêtre de continuation, avec seuils de réponse macroscopique près de $10^{-22}$ à $10^{-24}$.
