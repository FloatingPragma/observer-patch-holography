...
| Structure fine (inv.) | $\alpha^{-1}$ | valeur OPH côté source au point fixe 136.99483516462165 ; point final de clôture empirique 136.264 sur [136.158, 136.369] | 137.035999177(21) | le point final empirique utilise une compilation mesurée $e^+e^-\to$ hadrons ; son écart à la valeur mesurée est l'écart d'ancre dans le même schéma [0.649, 0.855], le running hadronique et d'ordre supérieur que l'ancre à une boucle ne peut porter ; un point final côté source exige la construction hadronique OPH |
| Boson de Higgs | $m_H$ | 125.20 GeV, enveloppe conditionnelle [125.18, 125.23] | 125.20 ± 0.11 GeV | conditionnel, aucune masse du Higgs ajustée |
