...
Le calcul électrofaible sépare trois objets numériques. La carte exacte du
porteur sélectionné donne
$(m_W,m_Z)=(80.3862916924,91.1829044467)$ GeV. Une loi de valeurs archivée donne
$(80.3770000154,91.1879780779)$ GeV comme conséquence exacte des cinq prémisses
de transport sur le quotient QT1--QT5, dont le certificat sur le porteur fini
n'est pas émis. Un adaptateur figé donne $(80.377,91.1879780919)$ GeV à seule
fin de comparaison. Aucun de ces objets n'est un théorème sur les pôles
complexes physiques.

Le modèle quadratique équilibré en couleur, avec les poids proposés
$\sqrt{N_c}/2$ et $N_c$, constitue une alternative distincte à la loi
complète de transport sur le quotient. L'accord numérique ne sélectionne pas l'un de ces
modèles. Le résultat source propre est la hiérarchie sans dimension
$v/E_\star$ sur chaque branche de pixel nommée ; une valeur physique indépendante
de $E_\star$ est nécessaire pour obtenir une masse en GeV. La coordonnée D11 du
Higgs est conditionnelle à la surface déclarée de running, d'appariement et de
seuils. Un triplet de masses bosoniques fermé côté source exige aussi une racine
source stricte, un certificat dérivé de transport sur le quotient, un paquet de
schéma figé, la rigidité de branche, une provenance prospective ainsi que des
certificats de pôles complexes et d'incertitude.
...
| Structure fine (inv.) | $\alpha^{-1}$ | témoin de branche d'audit source 136.99483516462165, pas encore preuve complète du point fixe final ; point final de clôture empirique 136.264 sur [136.158, 136.369] | 137.035999177(21) | la branche source stricte exige encore la preuve d'intervalle de l'application auto-cohérente projetée par Ward ; le point final empirique utilise une compilation mesurée $e^+e^-\to$ hadrons, et son écart à la valeur mesurée est l'écart d'ancre dans le même schéma [0.649, 0.855] |
| Boson de Higgs | $m_H$ | coordonnée aval D11 conditionnelle 125.1995304097 GeV sur la surface déclarée de running, d'appariement et de seuils | 125.20 ± 0.11 GeV | hérite des portes de racine source, d'échelle physique, de transport sur le quotient, de schéma, de rigidité, de provenance, d'incertitude et de pôle complexe |
| Quark top | $m_t$ | coordonnée compagnon 172.3523553288 GeV sur la même surface conditionnelle | 172.1 ± 0.6 GeV | aucune ligne publique distincte de prédiction de la masse du top |
| Boson W | $m_W$ | porteur sélectionné 80.3862916924 GeV ; candidat archivé de loi de valeurs QT1--QT5 80.3770000154 GeV ; adaptateur figé 80.377 GeV | 80.3692 ± 0.0133 GeV | carte exacte, implication conditionnelle et adaptateur de comparaison ; aucune ligne de masse pôle promue |
| Boson Z | $m_Z$ | porteur sélectionné 91.1829044467 GeV ; candidat archivé de loi de valeurs QT1--QT5 91.1879780779 GeV ; adaptateur figé 91.1879780919 GeV | 91.1876 ± 0.0021 GeV | carte exacte, implication conditionnelle et adaptateur de comparaison ; aucune ligne de masse pôle promue |
| Leptons chargés | $m_e,m_\mu,m_\tau$ | rétrodiction Stage-5 figée : 0.510882243295 MeV, 105.635282871 MeV, 1776.579124017 MeV. Un candidat distinct, informé par les cibles et fondé sur l'incidence des faces icosaédriques, donne 0.510998950843394 MeV, 105.658375501481 MeV, 1776.930000014351 MeV sur une branche hybride | 0.51099895069 MeV, 105.6583755 MeV, 1776.93 MeV | la géométrie exacte $A_5/C_3$ est dérivée. L'application de réparation déclarée est conditionnellement contractante avec un point fixe unique, mais des témoins multiplicatifs montrent qu'elle n'est pas sélectionnée. Le chiffre de 0.000300 ppm emploie les champs arrondis ; le résidu du tau vaut -1.387289 ppm face à la valeur centrale plus précise du paquet. L'attachement physique, les lois sources de phase et de déterminant, la branche cohérente, le raffinement et le schéma pôle restent ouverts ; ce n'est pas une prédiction promue |
| Spectre des masses des quarks | $m_q$ | les équations sources laissent deux modules positifs indépendants ; lignes numériques masquées | six masses courantes mesurées dans plusieurs schémas | lemmes exacts d'algèbre finie, diagnostic-gabarit informé par les cibles à 0.2946 %, et candidat rétrospectif RSCC à 0.29436 %. RSCC retire cinq décimales directes mais les remplace par un registre module/rang/signe/cumulant non démontré et informé par les cibles ; les reçus F1--F6 restent ouverts et aucune rétrodiction physique n'est promue |
...
- **Papier 3. [Deriving the Particle Zoo from Observer Consistency](paper/deriving_the_particle_zoo_from_observer_consistency.pdf)** : dérivation et audit du secteur particules. Il porte la reconstruction pilotée par $P_\star$, les modes porteurs classiques conditionnels avec leurs portes de particule quantique encore ouvertes, le pont de porteur à un Higgs de Borel-Weil, les branches électrofaible/Higgs/top, quarks, leptons chargés, neutrinos et hadrons, les vérifications quantitatives et la couture conditionnelle de lignes d'enregistrement. Son registre électrofaible sépare la carte exacte du porteur sélectionné, la loi de valeurs archivée qui découle de QT1--QT5 et l'adaptateur figé de comparaison. Le certificat QT sur le porteur fini n'est pas émis. Le modèle amplitude/boucle équilibré en couleur constitue une alternative distincte plutôt que la loi QT complète, et la coordonnée du Higgs demeure conditionnelle à sa surface aval déclarée. Le papier consigne aussi le point final de structure fine empirique $e^+e^-\to$ hadrons. Dans la branche des quarks, les équations sources laissent une fibre libre $(\mathbb R_{>0})^2$ pour les étalements. MAR attribue le même score structurel à chaque redimensionnement positif de cette fibre, car son vecteur de complexité ne contient aucune valeur propre de Yukawa. Les lemmes exacts sur la chaleur de $S_3$, le plan centré, les coordonnées de rayon et la trace normalisée conditionnelle sont consignés. Un évaluateur à deux modes informé par les cibles atteint un résidu maximal de 0.2946 % dans le tableau mixte mais consomme un gabarit manuscrit et une branche $P$ dépendante de Stage-5. Le candidat RSCC ultérieur retire les cinq décimales directes du gabarit et atteint 0.29436 % après avoir déclaré un registre fini de modules, effets et signes, lui aussi choisi après connaissance des cibles. Il ne dérive ni ce registre, ni la troncature gaussienne, ni les lois affines héritées, ni une échelle cohérente, ni le paquet RG ; son ablation d'ordre inférieur ajuste même mieux le même tableau rétrospectif. Les deux restent des diagnostics de découverte, pas des rétrodictions physiques ; les lignes numériques demeurent masquées. La branche des leptons chargés contient le théorème exact du porteur formé par les faces icosaédriques et leurs trois sommets. Une continuation presque exacte est conservée comme conjecture de complétion informée par les cibles, hors de la surface théorématique. La dérivation de la matrice physique de mélange des neutrinos et de leurs masses absolues est un travail en cours.
