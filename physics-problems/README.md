...
- [Homochirality as Prebiotic Record-Branch Selection](homochirality.md): a
  ...
  distinct source terms, and states the finite empirical acceptance boundary
...
- [Plasma Fusion and Confinement](plasma_fusion.md): fusion as an OPH
  ...
  cycles, Lawson as a scalar energy projection, Hydrosahedron as an acoustic
  carrier/control specialization, and DD products, captured heat, delivered
...
- [High-Temperature Superconductivity](high_temperature_superconductivity.md):
  high $T_c$ as charge $2e$ repair plus $U(1)_Q$ phase confluence. The note
...
- [Universality of Low-Temperature Amorphous Solids](low_temperature_amorphous_universality.md):
  ...
  branch. The note treats each material as a bounded self-reading patch with
  strain-visible ports, two-basin records, repair or tunneling moves, and
  public acoustic or thermal receipts. It derives
...
- [Fractional Quantum Hall States](fractional_quantum_hall.md): fractional Hall
  ...
  no-go theorem. The fractional-exciton extension adds optical-module and
...
- [JWST Compact Objects as Source-Release Record Surfaces](jwst_compact_object_source_release.md):
  ...
  catalogs do not, by themselves, confirm OPH.
...
- [Gamma-Ray Morphology Claims in OPH](gamma_ray_morphology_claims_in_oph.md):
  ...
  frozen source-derived morphology claims, requires count-space instrument
...
- [Finite E8/Spin8 Triality Certificate for an Alt(9) Double Cover](e8_spin8_triality_alt9_certificate.md):
  ...
  paper stack summarizes its role, so this lives here as a local receipt note
  rather than as a standalone release paper.
