...
The letters say the same thing and say why it happens: ports minus seams plus faces is P minus five P over two plus five P over three, which over a common denominator of six is six P minus fifteen P plus ten P, all over six, and that is P over six. The counting alone, with nothing about shape anywhere in it, ties the port count to the one combination a sphere pins down.
...
## Four around a point, six around a point
