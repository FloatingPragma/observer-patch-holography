...
**Action.** The action is the quantity a physical history makes stationary.
...
**Automorphism.** An automorphism is a transformation of a structure that
...
**Code space.** A code space is the protected subspace in an error-correcting
...
**Consistency.** Consistency means agreement on shared observables, not
...
**Density matrix.** A density matrix $\rho$ is a quantum state written in a
...
**de Sitter space.** de Sitter space is the symmetric spacetime associated
...
**Effective theory.** An effective theory is a description valid in a regime,
...
**Eigenvalue and eigenstate.** An eigenstate is a state in which a measurement
...
**Entanglement.** Entanglement is quantum correlation that cannot be reduced
...
**Entanglement wedge.** An entanglement wedge is the bulk region reconstructible
...
**Entropy.** Entropy measures multiplicity, uncertainty, or missing
...
**Error correction.** Error correction protects logical information against
...
**Locality.** Locality means that operations in separated regions cannot be
...
transport path. If it is zero, the local pieces pass that particular gluing
test.
...
**Projector.** A projector is an operator that asks a yes-or-no quantum
...
**Public fact.** A public fact is not a private impression. It is a record or
regularity stable enough to be checked across observers. OPH identifies
objectivity with this overlap-stable public layer.

**Quantum Darwinism.** Quantum Darwinism is Zurek's account of how the
...
**Quantum marginal problem.** The quantum marginal problem asks when local
...
**Qudit.** A qudit is a finite-dimensional quantum system with $d$ levels. A
qubit is the special case $d=2$. Screen models can use qudits on links or
cells to keep the fundamental bookkeeping finite.

**Quotient.** A quotient identifies descriptions that act the same for the
...
**Renormalization.** Renormalization tracks how effective parameters change
...
**Thermal time.** Thermal time is the proposal that time flow can be read
