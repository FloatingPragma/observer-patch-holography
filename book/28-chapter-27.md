...
Dynamical matter can be included through a separately supplied charged scalar field. Its interpolation changes with the electromagnetic potential in exactly the way gauge symmetry requires. Both fields then follow one stationary action. Its nonnegative conserved energy ensures global classical solutions of the finite equations. An explicit initial field carries opposite charges near the centre and the boundary. The chosen matter law, charge, mass and interaction strength are inputs. A physical interpretation also needs control of spatial refinement and a connection between the calculated fields, observer records and measured time.
