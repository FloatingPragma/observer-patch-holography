...
Allowing that one move changes the audit. Under the completed law, exactly one arrangement out of 1,352,078 rests. It is the balanced one. From every other arrangement there is a path of at most three events to a strictly lower level. Most of the stuck ones need two.
