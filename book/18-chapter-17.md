...
The exact OPH result in this chapter is Lorentz-frame kinematics on the declared geometric modular branch. A three-dimensional future-unit frame space is not a populated event space. Physical light cones, event locations and a universal signal speed additionally require the event-manifold, causal-faithfulness, ruler and clock receipts; the informational read-from order supplies none of them by itself.
