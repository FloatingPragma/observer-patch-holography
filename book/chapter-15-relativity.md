...
normalization and an irrelevant constant.
...
A third route appears here. Extra gravitational pull can come from
...
correlation remains out of reach. That leftover correlation shows up as an
extra term in Einstein's equations.

It gravitates because missing recoverability has physical weight in the
bookkeeping. No new particle fluid has to be invented.

### Why It's Dark

This sector is dark by construction. It comes from information structure, it
gravitates, and it does not couple electromagnetically. The result is a dark
component written directly into the bookkeeping.
