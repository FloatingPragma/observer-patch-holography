...
Generated by `tools/build_premise_register.py` from `tracking/premise_register.json`; edit the JSON, then regenerate. [Issue #727](https://github.com/FloatingPragma/observer-patch-holography/issues/727) owns this register.

Every named premise the V3 composition lanes consume appears here exactly once, with its type, its declared disposition, the lanes that consume it, its exact statement, and its evidence paths. A premise used by a lane theorem and absent from this register is a hard audit failure. P and N are the only proposed fundamental free numerical parameters; measured calibrations, fits, targets, and transport payloads remain separate flagged empirical inputs. Every numerical quantity is classified in this ancestry rather than hidden by the P/N statement. Registering a premise legitimizes its use inside conditional compositions; it does not make the premise true, derived, or physical. Disposition changes, including promotion to axiom, are recorded events with rationale, never silent edits.

Every `remove` or `axiomatize` row is projected into the generated [premise-discharge queue](PREMISE_DISCHARGE_QUEUE_V3.md), with its exact statement, evidence, conditional-consumer edges, next action, and durable architecture/audit-register custody established under issues #741 and #738. Imports are listed there as explicit exclusions rather than silently entering the queue.
...
| PR-53 | physical photon field, frame, and comparison attachment | `structural_rule` | `remove` | [#733](https://github.com/FloatingPragma/observer-patch-holography/issues/733), [#736](https://github.com/FloatingPragma/observer-patch-holography/issues/736), [#738](https://github.com/FloatingPragma/observer-patch-holography/issues/738), [#740](https://github.com/FloatingPragma/observer-patch-holography/issues/740) |
...
- Type `structural_rule`; disposition `remove`; consumed by [#730](https://github.com/FloatingPragma/observer-patch-holography/issues/730).
- Evidence: `Lean/EventAlgebra/QuantumAdequacySurface.lean`, `Lean/Dynamics/StoneConverse.lean`, `claims/assumption_dictionary.md`.
...
- Evidence: `Lean/ObserverPatchHolography/Locality/NoSignalling.lean`, `Lean/ObserverPatchHolography/Locality/AdaptiveScheduler.lean`, `claims/assumption_dictionary.md`.
...
- Evidence: `Lean/Variational/MechanicsAdequacySurface.lean`, `Lean/Variational/DiscreteNoether.lean`, `claims/assumption_dictionary.md`.
...
- Type `structural_rule`; disposition `remove`; consumed by [#734](https://github.com/FloatingPragma/observer-patch-holography/issues/734), [#735](https://github.com/FloatingPragma/observer-patch-holography/issues/735).
- Evidence: `Lean/Screen/SMStructureAdequacySurface.lean`, `Lean/Screen/Z6Descent.lean`, `paper/deriving_standard_model_gauge_structure_from_observer_overlap_consistency.tex`.
...
- Evidence: `Lean/Screen/SMStructureAdequacySurface.lean`, `claims/assumption_dictionary.md`, `paper/deriving_the_particle_zoo_from_observer_consistency.tex`.
...
- Evidence: `claims/assumption_dictionary.md`, `paper/deriving_the_particle_zoo_from_observer_consistency.tex`, `Lean/Screen/Z6Descent.lean`.
...
- Evidence: `claims/assumption_dictionary.md`, `paper/deriving_the_particle_zoo_from_observer_consistency.tex`, `code/particles/hierarchy/STATUS.md`.
...
- Evidence: `code/particles/flavor/derive_quark_axiom_level_yukawa_moduli_nonidentifiability.py`, `paper/deriving_the_particle_zoo_from_observer_consistency.tex`, `claims/assumption_dictionary.md`.
...
- Evidence: `claims/assumption_dictionary.md`, `code/capacity_readback/manifests/n_closure_branch_certificate.json`, `tracking/claims_scoreboard.md`.
...
- Evidence: `Lean/Geometry/CanonicalLorentzModule.lean`, `Lean/QFT/FiniteCausalObserverNet.lean`, `Lean/Geometry/EventFrameSoldering.lean`, `claims/assumption_dictionary.md`.
...
### PR-53 physical photon field, frame, and comparison attachment

The internal seam-current action and its rank-two oscillator are identified with a physical photon or other declared field sector, a coherent frame and boost law, a calibrated clock and length scale, a cofinal gluing or continuum domain, and an operational wave-packet readout with nuisance and comparison semantics. The exact internal dispersion coefficients alone supply none of these attachments.

- Type `structural_rule`; disposition `remove`; consumed by [#733](https://github.com/FloatingPragma/observer-patch-holography/issues/733), [#736](https://github.com/FloatingPragma/observer-patch-holography/issues/736), [#738](https://github.com/FloatingPragma/observer-patch-holography/issues/738), [#740](https://github.com/FloatingPragma/observer-patch-holography/issues/740).
- Evidence: `Lean/Screen/LightSignalAdequacySurface.lean`, `claims/frozen_prediction_register.json`, `docs/FROZEN_PREDICTION_LADDER.md`.
- Disposition note: Removal needs a target-clean physical field/readout bridge. A predictive comparison remains ineligible until this row and the applicable custody and power contracts are discharged.
...
- Type `structural_rule`; disposition `remove`; consumed by [#733](https://github.com/FloatingPragma/observer-patch-holography/issues/733), [#734](https://github.com/FloatingPragma/observer-patch-holography/issues/734), [#735](https://github.com/FloatingPragma/observer-patch-holography/issues/735), [#740](https://github.com/FloatingPragma/observer-patch-holography/issues/740), [#743](https://github.com/FloatingPragma/observer-patch-holography/issues/743), [#744](https://github.com/FloatingPragma/observer-patch-holography/issues/744), [#745](https://github.com/FloatingPragma/observer-patch-holography/issues/745).
- Evidence: `Lean/Screen/SMStructureAdequacySurface.lean`, `Lean/Screen/GaugeKineticInvariantForms.lean`, `paper/deriving_standard_model_gauge_structure_from_observer_overlap_consistency.tex`.
...
- Evidence: `Lean/Screen/BaryonDimensionSix.lean`, `code/a5_closure/baryon_dimension_six_census.py`, `claims/claim_registry.yaml`.
...
- Evidence: `Lean/Screen/BaryonDimensionSix.lean`, `code/a5_closure/baryon_dimension_six_census.py`, `code/a5_closure/receipts/baryon_dimension_six_census.receipt.json`.
...
- Evidence: `Lean/Screen/BaryonDimensionSix.lean`, `claims/claim_registry.yaml`, `code/particles/runs/status/postdiction_ledger.json`.
- Disposition note: Removal needs a same-architecture matter/QCD/action construction and an operational decay comparison. The current exact result is only a conditional finite operator census.
