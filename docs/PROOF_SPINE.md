...
- Release: `r1577`
- Projection SHA-256: `3de348e5f2a954cc745233a8674ad0c083e8cad67bf13507b9463a2d946892b3`
- Registry: 56 canonical claims (`physical_establishment` 0, `empirical_implementation` 2, `emitted_artifact` 3, `branch_entry` 1, `conditional_implication` 40, `declared_structure` 10)
- Claim gates: 25 distinct open issues across 21 gated claims
- Open-problem ledger: 51 open issues
- Undischarged physical identifications: 6
...
- **GAP-B5.** Charged-lepton source completion. A 24-stage register fixes no
  ...
  attachment, phase, and numerical ratios are open. The MCPR triple was
  historically target-informed and is a diagnostic coordinate; its
