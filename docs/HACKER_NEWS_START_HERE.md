...
- a Lean 4 library of more than 4700 checked theorems and lemmas with no
...
| Status | Contents |
| --- | --- |
| Proved, machine-checked | More than 4700 Lean theorems and lemmas: finite consensus core, gauge identifiability, Einstein-branch composition, and a negative result against the naive version of the program's own claim |
