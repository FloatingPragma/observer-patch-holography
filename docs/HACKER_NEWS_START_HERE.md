...
- a sorry-free Lean 4 library of more than 1600 checked theorems and lemmas, each public
...
| Status | Contents |
| --- | --- |
| Proved, machine-checked | More than 1600 Lean theorems and lemmas: finite consensus core, gauge identifiability, Einstein-branch composition, and a negative result against the naive version of the program's own claim |
