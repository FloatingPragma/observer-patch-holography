...
| Realized Standard Model matter image | The displayed maximal faithful matter image, hypercharge assignments, anomaly cancellations, shared center, color count, generation count, or declared one-Higgs completion is mathematically inconsistent under its stated realized-branch premises. | D8--D9 fall in the affected part. Physical global-form selection has a separate gate. |
