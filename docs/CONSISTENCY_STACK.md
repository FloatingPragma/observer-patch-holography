...
$N=\log M_0(\mathfrak U_N)$. At finite cutoff freeze one carrier dimension
...
[HADRON.md](HADRON.md)). The source transport function and
same-scheme remainder are work in progress. No registered target or scoring
protocol exists.
