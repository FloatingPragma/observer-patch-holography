...
| FZ-07 | Rotor RAR/BTFR scatter law stance | resource_deferred | to freeze | resource-deferred | to freeze at M5 before comparison data is examined |
| FZ-08 | DESI w(z) stance | resource_deferred | to freeze | resource-deferred | to freeze at M5 before comparison data is examined |
| FZ-09 | Vacuum birefringence null | resource_deferred | to freeze | resource-deferred | to freeze at M5 before comparison data is examined; the FZ-01 registry row is THEOREM-TARGET until the emission theorem exists |
