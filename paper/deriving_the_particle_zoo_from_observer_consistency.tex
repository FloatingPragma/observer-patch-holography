...
\((m_W,m_Z)=(80.330,91.119)\)~GeV, while the stated criticality branch gives
\((m_H,m_t)=(125.77,172.63)\)~GeV.
...
finite source-scale mass response. MAR selection of the accepted chiral sector, its physical
carrier and refinement data, positivity, mass-scheme descent, and the all-orders
threshold or resonance continuation are work in progress.
...
The count \((N_c+1)/(2N_cN_g)=2/9\) is arithmetic. A physical phase theorem requires a
