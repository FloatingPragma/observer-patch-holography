...
normalization this is exactly the \((1,2)_{1/2}\) Higgs carrier. A nonzero section direction is a
point of \(\mathbb P(H_{\rm OPH})\cong\mathbb{CP}^1\), whose stabilizer is the electromagnetic
\(\U(1)_Q\). This explains the representation, charge, and symmetry-breaking geometry of the
one-Higgs slot. It does not derive \(m_H\), the quartic, \(v\), or Coleman--Weinberg dynamics; the
