...
``repair the PMNS branch.'' The repaired weighted-cycle route closes those steps.
...
discrete branch remains on that repaired lane: the remaining freedom is only the positive
