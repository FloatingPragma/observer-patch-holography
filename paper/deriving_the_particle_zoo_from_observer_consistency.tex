...
The finite matter typing is fixed on the declared source carrier. Laboratory
current identification and the intertwiner between the two current objects
are open.
...
\item the declared generation and sector completions, each with an open
physical attachment.
\end{enumerate}
...
matter packet. A physical particle interpretation requires source binding,
...
\]
The interval inversion is exact. No source-derived physical transition or
clock gap supplies its inputs.
