...
\]
If the exact global capacity source certificate supplies
\(\mathcal B_{\mathrm{EW}}(P_\star,N_{\mathrm{CRC}})=0\), then
\[
\frac{v}{E_{\mathrm{cell}}}
=
\left(\frac{N_{\mathrm{CRC}}}{\pi}\right)^{-P_\star/12}
...
records the closed global repair tick, joint product branch, electroweak projection bridge, and
RG naturality square. The theorem-grade full resonance requires the finite readback-resolution
verification, the representation-to-spectrum derivation of the \(24\)-round count, and the exact
global capacity source certificate satisfying \(\mathcal B_{\mathrm{EW}}=0\). The promoted
hierarchy row does not use it as an input.
