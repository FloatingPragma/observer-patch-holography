...
\ophid{quark_d12_t1_value_law} on the already-emitted D12 mass ray, with
...
Quark family & up quark & overlap continuation & reported value \(0.00228766~\mathrm{GeV}\); stronger two-scalar candidate \(0.00215992~\mathrm{GeV}\) & the selected D12 sheet is a strict no-go for the physical CKM shell; the local selector closes to \(\sigma_{\mathrm{ref}}\), so the next exact object is \ophid{quark_d12_t1_value_law} on the emitted D12 mass ray \\
Quark family & down quark & overlap continuation & reported value \(0.00512144~\mathrm{GeV}\); stronger two-scalar candidate \(0.00470005~\mathrm{GeV}\) & same wrong-branch D12 frontier; same-sheet CKM/CP transport is closed, the local selector is fixed to \(\sigma_{\mathrm{ref}}\), and the next quark object is \ophid{quark_d12_t1_value_law} on the emitted D12 ray \\
Quark family & strange quark & overlap continuation & reported value \(0.0916111~\mathrm{GeV}\); stronger two-scalar candidate \(0.0935045~\mathrm{GeV}\) & same wrong-branch D12 frontier; the local selector is fixed to \(\sigma_{\mathrm{ref}}\), so the next quark object is \ophid{quark_d12_t1_value_law} on the emitted D12 ray \\
...
\emph{not} yet emit is the distinguished modulus on that ray. The exact next theorem object is the
value law \ophid{quark_d12_t1_value_law}, which identifies the ray modulus as \(t_1\) on the
emitted ray. Until that law is emitted, any numerical \(t_1\) is only a compare-only choice
of \(\lambda\) on this ray, not a theorem-grade branch emission.
...
\item on that emitted negative-closure branch, the sole next theorem object is the one-scalar law \ophid{quark_d12_t1_value_law} on the emitted D12 mass ray. The wrapper \ophid{intrinsic_scale_law_D12} is retained only as the derived packaging of that scalar law and does not introduce a second primitive burden.
\end{enumerate}
...
\begin{enumerate}[leftmargin=2em]
\item on the emitted same-label left-handed solver surface, the orbit closes negatively to \(\sigma_{\mathrm{ref}}\), and \(\sigma_{\mathrm{ref}}\) is the wrong D12 CKM sheet. The corpus emits no sector-attached left-handed same-label branch-changing transport from that selected sheet to the physical CKM shell. The selector task is therefore closed in the negative sense. On that emitted branch the sole remaining same-family theorem object is the one-scalar law \ophid{quark_d12_t1_value_law} on \(D12_{ud}^{\mathrm{mass}}=\mathcal R_{D12}^{ud}\) (paper id \ophid{D12_ud_mass_ray}), with \ophid{intrinsic_scale_law_D12} retained only as the derived wrapper. CKM and CP closure remain downstream of the wrong-sheet no-go rather than a second open selector task;
