...
The unit-splitting cost, D-optimal selector, port/weak-carrier intertwiner,
normalized port-load trace equality, and common screen/electroweak
load-carrier map are physical branch premises. Their source
production is work in progress. The exact exterior multiplicity alone does
not discharge the physical load identity.
