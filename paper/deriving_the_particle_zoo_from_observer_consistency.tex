...
declared finite constants under PR-67--PR-69: a quartic coupling \(\lambda>0\), a
...
mass formulae additionally requires the open scalar kinetic and generator
normalizations of PR-48 and the physical vacuum attachment PR-49.
...
the committed grammar: it supplies no physical current operator, no source
action, no measured mixing angle, no running, and no decay amplitude, and
the chirality and source-action attachments stay open register rows.
...
committed. The dictionary supplies no physical current operator, no source
action, no W propagator, no decay amplitude, no Fermi limit, and no flavor
or mixing-matrix content, and the same chirality and source-action
attachments stay open register rows.
...
clock-calibration and physical-spacetime attachments stay open register
rows.
