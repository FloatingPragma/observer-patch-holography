...
record code. Its selector-free finite form is robust global screen capacity
\[
...
the separate screen-capacity branch through the robust cosmic record-closure target
\[
\mathfrak F_{r,0}(D_\star)=\{D_\star\},
\qquad N_{\mathrm{CRC}}=\log D_\star,
\qquad
