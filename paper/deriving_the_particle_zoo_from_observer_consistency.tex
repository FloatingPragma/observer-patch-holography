...
defect in its declared chart, and conditional Higgs/top coordinates. Its
...
The flavor calculations also expose sharp boundaries. A connected
six-dimensional charged-lepton response register derives the Koide balance
\(Q=2/3\), while its physical chiral-mass attachment is work in progress. The
reciprocal quark candidate misses held-out Yukawa coordinates by \(21.56\%\),
and the weighted-cycle neutrino candidate fails its oscillation-data test.
Absolute lepton and hadron masses therefore appear only on explicitly
empirical closure surfaces. The closure equations and gravitational branch
belong to \emph{Observers Are All You Need} and the compact Standard Model and
