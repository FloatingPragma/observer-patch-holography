...
projector at its lowest positive generator frequency. Its physical rank-45
matter attachment is open. Classical massless
...
window. The screen-band theorem supplies a conditional finite selection with
matter-pole, chirality, locality, refinement, and laboratory identification
open. Completeness for extra light sectors is a separate open attachment.
...
target-anchored empirical-closure surface, the measured charged-lepton triple
lies inside every outward-rounded arithmetic enclosure. These are diagnostic
intervals rather than prospective prediction intervals. The lane inverts exactly at the witness: one
...
premises alone, and the window by itself leaves the generation count open.
The \(A_5\) graph, anomaly cancellation, and target-free matter reduct do not
...
frequency. This finite response mode has no physical family interpretation
without the matter-pole, chirality, locality, refinement, and laboratory
receipts. The paper also supplies the exact
...
premises alone. The target-free matter reduct leaves the three-generation
value unselected. On the strengthened screen interface, exact cost
minimization selects the canonical rank-three band and the declared simulator
realizes its response residue. The band remains a candidate family fiber until
the physical rank-45 matter-pole attachment is proved.
...
completeness gives \(3\le N_g\le5\). The exact screen-band theorem selects
...
Witten parity is a consistency check. These steps do not construct the
physical rank-45 matter-pole attachment or exclude extra light sectors.
...
target-anchored continuation mass ratios,
...
target ancestry. The construction adds no axiom. The interval lane carries
absolute masses only on the empirical-closure surface; the source-only charged
no-go is in force.
...
shape and the open object is a source mechanism beyond that truncation.
...
supplies an exact finite family candidate. Physical three-family attachment is
part of the harder flavor closure problem because matter-pole identification,
chirality, locality, refinement, and laboratory attachment are open.
...
the two routes' current identity, the physical rank-45 matter-pole attachment,
scalar multiplicity/dynamics, and continuum QFT are open. The strengthened
