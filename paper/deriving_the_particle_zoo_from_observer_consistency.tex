...
model assumptions~\cite{desidr2nu}. A cosmological upper bound below the emitted value would
directly pressure the weighted-cycle absolute-mass branch if it comes from a model class that also
respects oscillation lower limits and the OPH background assumptions.
