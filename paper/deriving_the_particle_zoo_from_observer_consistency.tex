...
\(3\le N_g\le5\), which leaves the generation count open.
...
while selection of the physical global form is open. Separate intrinsic-CP
...
\(3.532\times10^{122}\) is about \(6.6\) percent above the Planck
base-\(\Lambda\)CDM comparison coordinate near \(3.313\times10^{122}\).
...
\(3.2921\times10^{122}\); the exponential mean-count branch gives
\(3.3001\times10^{122}\). Neither attachment is derived, and both comparisons
...
Planck base-\(\Lambda\)CDM comparison coordinate
...
\[
N_{\rm pres}=N_{\mathrm{EW}}\left(1-\frac{P}{24}\right).
\]
On the source-forward numerical branch this is
\(3.2921\times10^{122}\), about \(0.63\) percent below the Planck
base-\(\Lambda\)CDM comparison coordinate. The exponential expression
\[
N_{\rm Pois}=N_{\mathrm{EW}}e^{-P/24}
\]
is a distinct mean-count or continuum branch and needs a carrier beyond the
finite projection trace. It gives \(3.3001\times10^{122}\), about \(0.39\)
