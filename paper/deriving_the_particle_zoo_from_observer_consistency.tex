...
Observer-Patch Holography (OPH) into particle calculations. Its finite source
model selects the odd-Weyl Spin typing, the Standard Model charge lattice,
and the maximal faithful matter image
\((\mathrm{SU}(3)\times\mathrm{SU}(2)\times\mathrm{U}(1))/\mathbb Z_6\)
on the declared carrier. Laboratory identification of the current and flux
sectors, physical seam and family attachment, four-dimensional topology,
scalar dynamics, and continuum quantum-field realization are work in
progress.
...
and conditional Higgs and top coordinates. A strict finite-order \(W/Z\)
pole algebra and two external Standard Model calculation engines test the
matching protocol. They do not produce an OPH-native weak-boson pole. A
...
The Standard Model gauge paper supplies an exact finite source-model current
algebra, the odd-Weyl Spin typing, the hypercharge lattice, a three-color
carrier, and the maximal faithful matter image
\((\SU(3)\times\SU(2)\times\U(1))/\mathbb Z_6\) from the incidence,
response, and matter premises alone. The source packet thereby selects the
\(\mathbb Z_6\) quotient on its declared carrier. It also supplies
...
projector at its lowest positive generator frequency. A finite source-domain
attachment gives the tensor product with the exact generation witness complex
rank \(45\), together with nondegenerate chirality, exact diagonal
\(\mathbb Z_6\) action, local signed operators, and an inherited positive
dimensionless gap. Its identification with physical matter poles and
continuum fields is open. Classical massless
...
The finite source packet selects the maximal faithful \(\mathbb Z_6\)
quotient on its declared carrier. This does not identify the finite flux
sectors with laboratory currents or choose the physical seam action.
...
an exact finite rank-45 matter attachment. Chirality, local support, and
Spin-candidate data are supplied on the declared local domain. Matter-pole
identification, continuum Spin/locality, the physical seam choice, the third
persistence leg, and laboratory identification are open. Completeness for
extra light sectors is a separate open attachment.
The finite matter typing and rank-45 local attachment are fixed on the
declared source carrier. Laboratory current identification and the
...
frequency. The finite local-domain attachment tensors this mode with the
generation witness to give the exact rank-45 chiral carrier and its local
signed operator. It has no physical family interpretation without the
matter-pole, continuum, seam-selection, persistence, and laboratory receipts.
...
\item the rank-three screen selection, finite rank-45 local attachment, and
declared physical generation and sector completions.
\end{enumerate}
...
matter packet. The finite local-domain branch supplies its rank-45 chiral
carrier. A physical particle interpretation requires source binding,
laboratory current identification, matter-pole and continuum attachment,
...
and equality with the Tannaka current are open. The finite rank-45 carrier
does not become a physical family without the matter-pole, continuum,
seam-selection, persistence, and symmetry-descent receipts.
...
realizes its response residue. On the finite local domain, its tensor product
with the generation witness supplies the exact rank-45 carrier. The carrier
remains a candidate family fiber until its physical matter-pole and continuum
attachments are proved.
...
physical three-family interpretation requires the finite rank-45 carrier to be
identified with physical matter-pole residues and continuum fields. Their
...
window is conditional and its three-generation completion is declared. The
finite rank-three-to-rank-45 attachment is exact on the declared local domain;
its physical matter-pole and continuum interpretation is open. The
...
Electroweak \(W/Z\) & source-only running/chart coordinates \((80.330,\,91.119)\)~GeV; candidate value-law coordinates \((80.3770000154,\allowbreak\,91.1879780779)\)~GeV; no OPH-native pole & these coordinates are not commensurate with the PDG mass-dependent-width Breit--Wigner masses or with complex-pole masses. The exact convention map gives energy-pole masses \(M_W=80.3411410\)~GeV and \(M_Z=91.1623040\)~GeV; the distinct coordinates \(\sqrt{\operatorname{Re}s}\) are \(80.3340218\)~GeV and \(91.1537725\)~GeV. The finite quotient-path certificate, source-law selection, matching prescription, theory covariance, and physical pole readout are open; numerical proximity is not mass evidence \\
...
executed public-record fixed point plus the common screen/electroweak load-carrier map. No source-only nonzero particle mass follows. The selected-carrier, value-law,
...
The particle derivation uses the three axioms, the screen-capacity closure, the
local pixel closure, the regulated screen realization, and the imported OPH
...
L\"uders-conditioning package together with the fixed-cutoff Bell/CHSH combined theorems used when
...
constructs the rank-45 matter carrier and its local signed operator. These
steps do not identify its physical matter poles or exclude extra light
sectors.
...
value-law pair \((80.3770000154,91.1879780779)\,\mathrm{GeV}\), the
conditional quotient-transport implication, and the measured-reference
inverse repair surface.
...
the smooth tick-map alternative. A finite-size slack law with one physical
...
flavor chapter. The imported input here is the color carrier \(N_c=3\) and
...
\paragraph{Target-conditioned cumulant specification.}
...
The fixed-cutoff measurement theorem gives the central record algebra, Born
probabilities, L\"uders conditioning, repeated-read stability, and the stated
two-wing Bell/CHSH result. It does not prove global observer continuation or
...
On the finite local-domain branch, the fifteen-state charge table is
recomputed with exact anomaly cancellation and diagonal \(\mathbb Z_6\)
action. Its charge multiset has a nondegenerate chirality grading. Tensoring
the measured rank-three band with that generation gives a complex
rank-\(45\) section space. The signed matter operator is the scalar local
operator tensored with the identity, so its zero kernel and exact positive
dimensionless gap are inherited with multiplicity \(45\). This finite
attachment supplies chirality, local support, and Spin-candidate data on the
declared domain. Matter-pole identification, the continuum Spin/locality
limit, physical seam selection, the missing persistence leg, and laboratory
current identification have no receipts~\cite{ophfpe}.
...
the two routes' current identity, rank-45 matter-pole and continuum
identification, scalar multiplicity/dynamics, and continuum QFT are open. The
strengthened
...
finite local-domain Hamiltonian has an exact positive dimensionless gap; it is
not a physical clock or mass scale. A nonperturbative chiral gauge construction would
...
screen/electroweak load. The particle results are stated separately as
