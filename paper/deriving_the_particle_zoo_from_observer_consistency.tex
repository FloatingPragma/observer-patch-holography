...
reversible port response and endogenous observer transport force the Standard
Model compact Lie type. A conditional finite matrix realization gives the
charge lattice and maximal faithful matter image
...
action, and global quotient is work in progress, as are laboratory current
and flux attachment, physical seam and family attachment, four-dimensional
topology, scalar dynamics, and continuum quantum-field realization.
...
and endogenous observer transport force the Standard Model compact Lie type.
...
the signed response. The complete-response theorem supplies the Lie type.
