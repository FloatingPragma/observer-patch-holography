...
\begin{abstract}
Observer-Patch Holography turns the particle problem into a forward calculation from one local screen scale. The \(P\)-closure branch compresses into five executable layers: unification scale, heat-kernel pixel closure, running transport, electroweak mixing, and Ward-projected Thomson transport. The fixed point gives \(\alpha^{-1}(0)=137.035999177(21)\) and \(P=1.630968209403959324879279847782648941\ldots\). The same pixel scale propagates into structural massless carriers, the weak sector, the Higgs/top row, selected-class running quarks, and a weighted-cycle neutrino absolute-mass branch. Hadrons require the separate OPH strong-binding backend. The status ledger records the exact scope of validation rows, charged-lepton witnesses, and backend-dependent hadron rows.
\end{abstract}
...
\]
The 2022 CODATA/NIST central value
\(\alpha^{-1}(0)=137.035999177(21)\) is the fixed-point readout
\[
P=1.630968209403959324879279847782648941\ldots.
\]
...
a built-in external inverse-\(\alpha\) value. The displayed CODATA/NIST value enters only as
compare metadata or as the measured calibration insert. The closure solve excludes it as an input.
