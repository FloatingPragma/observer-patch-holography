...
the realized Standard Model quotient, exact hypercharge, three colors, three
generations, and the connection and metric carrier roles. Classical massless
...
The compact paper supplies, with its stated branch conditions, the Standard
...
N_g=3.
\]
It also supplies the exact hypercharge lattice and a conditional exterior representation
witness. If a trace-balanced block carrier
