...
The paper-side quantum hierarchy is a DAG: QFT-Q2 exact finite quantization
and QFT-Q3 formal perturbative/BV quantization are parallel descendants of
QFT-Q1. The strict finite-order \(W/Z\) theorem lands at QFT-Q3; QFT-Q4 is
reserved for a separately constructed nonperturbative continuum and resonance
limit.
...
belong to \emph{Observers Are All You Need} and the compact SM/GR paper.
\end{abstract}
...
At that point one has a conditional carrier and matter packet, not yet a
physical particle catalog. Physical realization still requires the source,
...
Standard Model class, the hypercharge lattice, the color triplet \(N_c=3\), and the conditional economy value \(N_g=3\). The physical family attachment remains open.
...
theorem derives twelve unit curvature ports, their fixed-point-free inverse
...
The unit-splitting and proper-\(A_5\) source receipts are now closed on the
...
resolution is an independent test. The conditional screen has twelve ports
...
The realized Standard Model branch fixes the structural carrier and matter
content used here. On the declared quantitative branch, one local coordinate
