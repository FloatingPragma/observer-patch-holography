...
sheet. The quark continuation boundary is therefore the intrinsic scale law on the
already-emitted D12 mass ray.
...
The emitted same-label left-handed solver surface selects the singleton \(\sigma_{\mathrm{ref}}\) (\ophid{sigma_ref}). This is a negative closure because \(\sigma_{\mathrm{ref}}\) is the wrong D12 CKM sheet. No theorem-grade branch-changing route from the emitted D12 data to the physical CKM shell is derived. The exact next quark object is therefore the one-scalar law \ophid{quark_d12_t1_value_law} on \ophid{D12_ud_mass_ray}, with \ophid{intrinsic_scale_law_D12} retained as the derived wrapper. The exact-hit sidecar on top of that theorem boundary is the same-family selected-sheet witness \((u,d,s,c,b,t)=(0.00216,0.00470,0.0935,1.273,4.183,172.3523553288311)\,\mathrm{GeV}\), closed through \ophid{oph_quark_current_family_selected_sheet_exact_closure}. Its caveat is precise: it does not move the selected D12 sheet. The exact primitive split is as follows.
...
\begin{enumerate}[leftmargin=2em]
\item on the emitted same-label left-handed solver surface, the orbit closes negatively to \(\sigma_{\mathrm{ref}}\), and \(\sigma_{\mathrm{ref}}\) is the wrong D12 CKM sheet. No theorem-grade branch-changing route from the emitted D12 data to the physical CKM shell is derived. The remaining same-family theorem object is therefore the one-scalar law \ophid{quark_d12_t1_value_law} on \(D12_{ud}^{\mathrm{mass}}=\mathcal R_{D12}^{ud}\) (paper id \ophid{D12_ud_mass_ray}), with \ophid{intrinsic_scale_law_D12} as the derived wrapper;
...
The quark headline is narrower: quarks are the only matter family with reported numerical rows, the selector problem on the emitted solver surface is closed in the negative sense, and the next theorem-side target on that emitted branch is \ophid{quark_d12_t1_value_law}, with \ophid{intrinsic_scale_law_D12} as the derived wrapper. A target-anchored same-family exact witness reproduces the six quark reference masses exactly on the same ordered three-point family, and within that same-family scope the selected-sheet exact readout closes through \ophid{oph_quark_current_family_selected_sheet_exact_closure}, built on \ophid{oph_quark_current_family_quadratic_readout_theorem}; it does not collapse the wrong-branch D12 boundary. Any compare-only orbit improvement or chirality-basis diagnostic that is not sector-attached and left-handed same-label remains outside the theorem ledger.
