...
\((m_W,m_Z)=(80.330,91.119)\)~GeV, at \(2.9\sigma\) and \(\approx33\sigma\)
...
Electroweak bosons & strict source-audit branch plus exact chart, conditional quotient-transport theorem, and comparison adapter & source-audit zero-selector law; selected carrier \(\rightarrow\) two-coordinate mass chart; QT1--QT5 \(\Rightarrow\) unique value law & no nonzero mass in the prediction ledger; strict source-audit branch \((m_W,m_Z)=(80.330,\,91.119)\)~GeV within \(0.05\)--\(0.08\) percent of measurement (pulls \(2.9\sigma\) and \(\approx33\sigma\); closure row CL-5); the archived value-law coordinates \((80.3770000154,\,91.1879780779)\)~GeV, base-running, and measured-pair reparametrization (calibration) charts stay in the audit discussion & QT1--QT5 are not derived from the finite carrier; the discrete two-law choice awaits a source-law selection principle; no complex-pole receipt is emitted \\
...
\((m_W,m_Z)=(80.330,\,91.119)\)~GeV, with pulls \(2.9\sigma\) and \(\approx33\sigma\) against the
...
it is an exact interpolation of the PDG pair --- a target-anchored fit and not
a certified Higgs or top complex pole; the
...
display sits at \(2.9\sigma\) on \(M_W\) and \(\approx33\sigma\) on \(M_Z\)
...
m_Z &\in [91.1880,\,91.1983]~\mathrm{GeV}, & &\text{measured } 91.1876\pm0.0021.
\end{aligned}
\]
...
against the frozen target, closes or moves CL-1 and CL-2; G2, the capacity readback map \(F\)
with its contraction certificate, carries CL-3, CL-4, and CL-7; G3, the repaired forward
electroweak chain from the axioms under preregistered revisions, carries CL-5; G4, solver hygiene
delivering a matched printed pair at certified precision, closes CL-6. The one object beyond the
ledger is the source-derived flavor-orbit selector, and the two-modulus quark source-spread
non-identifiability theorem proved in this paper names that gap precisely: it states which
freedom the quark equations cannot fix from the declared source data, so the missing selector is
a specified construction rather than an open-ended search. Every item on this list is a
computation or a construction, not a reinterpretation.
