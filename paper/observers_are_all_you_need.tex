...
model, the same-half-line local modular-Hamiltonian input, and the separate bounded-interval
projective branch; on that D4 surface the exact-or-controlled strip additivity, the endpoint-Lipschitz
renormalized half-line family, the weak tail generator, and the positive null-translation generator
are internal to the bridge itself; and its D5 side adds fixed-cap stationarity,
