...
on the gauge quotient once the declared recovery-derived repair moves satisfy repair completeness,
strict decrease of the inconsistency potential \(\Phi\), and local confluence on the stated finite
patch-net branch.
