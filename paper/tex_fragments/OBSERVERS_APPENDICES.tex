...
Magnetic cocharacter and simple-GUT monopole boundary & Matter-image corollary with an open global-form boundary & Incidence and target-blind port readback derive the signed response and current algebra. Under the declared fermionic Spin category, the finite matter certificate derives the charge-conjugate rank-15 projector pair and its common central kernel \(\mathbb Z_6\). The quotient by that kernel is the maximal faithful image of the realized tensors. The cover and its \(\mathbb Z_2\), \(\mathbb Z_3\), and \(\mathbb Z_6\) quotients carry the same local tensors, so they do not select the physical global form. The cocharacter \((1,1,1/6)\) and its electromagnetic multiple apply to the maximal faithful image. A physical line spectrum requires a line category and ultraviolet polarization, while theta periodicity requires instanton-sector data. The product adjoint removes the simple-GUT X/Y production route, not all possible 't Hooft lines. \\
