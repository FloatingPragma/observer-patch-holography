...
appendix records only the synthesis-level restatement imported from that surface. The working OPH
reference architecture is a finite cellulation of the horizon screen with boundary-fixed patch
