...
read as follows. The table also records appendix-tier closure stories so they cannot float
outside the official claim ledger. In this table, ``Proved corollary of earlier theorems'' means
proved under the dependencies named in the row, including declared branch conditions and cited
...
\midrule
Quantum gravity consistency & Conditional theorem under explicit receipts & Lorentz and Jacobson-type Einstein branches follow from the support-visible BW scaling theorem together with the stated null-bridge and fixed-cap conditions; realized-branch nonemptiness for the composed Einstein branch entry is open. \\
...
Three generations & Proved corollary of earlier theorems & \(N_g=3\) is recovered on the realized Minimal Admissible Realization branch. \\
...
Edge-to-2D-YM / controlled large-\(N_{\mathrm{edge}}\) worldsheet branch & Proved corollary of earlier theorems & On the stated overlap-gauge, local-Gibbs/MaxEnt, compact-group, and large-\(N_{\mathrm{edge}}\) conditions, the edge-sector heat-kernel bridge and controlled Gross--Taylor worldsheet effective description are theorem-level. This is a two-dimensional partition and worldsheet-effective branch, separate from the four-dimensional compact-gauge theorem. \\
