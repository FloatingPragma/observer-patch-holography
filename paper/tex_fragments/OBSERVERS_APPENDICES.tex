...
Three generations & Conditional window, exact finite carrier, and a declared physical completion & CKM capability and the weak-sector clause give \(3\le N_g\le5\). Under the named band premises, rank three is selected, and its finite local-domain tensor product with the generation witness has rank \(45\), nondegenerate chirality, local signed operators, and the inherited positive dimensionless gap. Physical matter-pole and continuum identification, extra-sector completeness, and the charged-lepton and electroweak quantitative branches carry their own declared premises. \\
