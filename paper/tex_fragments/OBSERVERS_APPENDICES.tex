...
\]
This gives quantitative trace-distance control on the recovered state under finite CMI
(finite collar error). Interpreting that control as observer continuation
