...
physical federation, source, and support-screen premises are therefore not satisfied.
...
Ref.~\cite{ophmicrophysics} proves a conditional fixed-cutoff observer-facing
measurement interface: a finite central record algebra, a supplied Born
valuation for its event projectors, and a declared L\"uders instrument on that
same commuting record algebra. The projectors alone do not select the
instrument. This appendix uses that fixed-cutoff
