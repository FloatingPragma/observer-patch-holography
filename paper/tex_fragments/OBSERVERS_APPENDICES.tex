...
D6 cosmological-capacity closure under declared screen-capacity input & Proved corollary of earlier theorems & Once the external input \(N_{\mathrm{scr}}\) and the D6 identification \(N_{\mathrm{scr}}=S_{\mathrm{dS}}\) are declared, the same Einstein branch fixes \(\Lambda=3\pi/(G N_{\mathrm{scr}})\) and the static-patch readout. \\
