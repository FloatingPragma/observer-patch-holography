...
rather than nearby alternatives. On the current runtime surface this remains the open
RG/matching/threshold/scheme packet: scheme lock, threshold map, beta provenance, and interval
composition.
