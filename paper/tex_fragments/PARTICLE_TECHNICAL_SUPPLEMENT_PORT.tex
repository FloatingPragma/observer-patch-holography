...
calibration branch. The public D10 claim tier is explicitly Phase II rather than recovered-core
...
\subsection{\texorpdfstring{\(\mathcal R_U\)}{R\_U} Unified-Coupling Certificate v0.2}
...
charged-lepton absolute-scale, cesium nuclear, and atomic spectral enclosures. The v0.2 package is
...
P_{\mathrm{cand}}
=
\decnum{1.63097209569432901817967892561191884270169}.
\]
A converged precision-100 rerun supersedes this printed source-audit value beyond digit 10; the
certified converged value is \(P_{\mathrm{cand}} = 1.630972095858897\ldots\), interval-certified
unique on its interval and, by the domain-global certificate, the only fixed point of its
...
closure row CL-6, closed 2026-07-14). The packet is quoted here as frozen.
...
For \(P=P_C\), the v0.2 checker emits
\[
\begin{aligned}
...
\[
\begin{aligned}
\alpha_U(P_{\mathrm{cand}})&=0.04112424744557487,\\
\alpha_U(P_{\mathrm{cand}})^{-1}&=24.316554395881205,
\end{aligned}
\]
\[
\begin{aligned}
\frac{v(P_{\mathrm{cand}})}{E_\star}&=2.0198114150099223\times10^{-17},\\
\frac{\mu_Z(P_{\mathrm{cand}})}{E_\star}&=7.501767385088398\times10^{-18}.
\end{aligned}
\]
...
+\mathcal R_{\mathrm{atom}}^{133\mathrm{Cs}}.
\]
The v0.2 witness supports an electroweak hierarchy certificate. It does not support a 52-digit
