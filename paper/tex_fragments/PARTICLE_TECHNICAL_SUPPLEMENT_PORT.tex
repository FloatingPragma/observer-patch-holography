...
This appendix rehouses the D10 compact-group heat-kernel items from the former technical
supplement. The theorem-bearing leaf for the same-overlap thermal/Casimir law now lives on the
screen-microphysics paper surface at fixed cutoff. What is recorded here is the later
compact-group / Peter--Weyl lift and beta-shift bookkeeping used by the particle-side
calibration branch. The public D10 status remains explicitly Phase II rather than recovered-core
Phase I.
...
has derived a supersymmetric UV spectrum.
...
the plain SM coefficients. On the OPH lane this remains a benchmark matched by the D10
calibration branch, not a theorem that OPH has already derived a supersymmetric UV spectrum.
...
MSSM-like one-loop running remains a declared Phase II benchmark, not a promoted theorem-level
MSSM spectrum claim.

At the unification diffusion parameter \(t_U\approx 1.64\), the benchmark shift is
\[
