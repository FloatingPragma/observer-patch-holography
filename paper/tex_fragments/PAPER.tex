...
selects the \(\mathbb Z_6\) quotient on the declared finite carrier. Laboratory identification of
the current and flux sectors, equality of the two reconstruction routes, four-dimensional
instanton normalization and theta periodicity, monopole dynamics, scalar attachment and
multiplicity, quantum field realization, and physical family attachment are work in progress.
\else
...
content is not selected by any axiom: physical family attachment, scalar multiplicity, and
extra-sector completeness are open physical attachments, and each theorem below lists the
...
scalar attachment and multiplicity, rank-45 physical family attachment, QFT realization, and
