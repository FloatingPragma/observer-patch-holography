...
That bridge is \(N_{\mathrm{bridge}}\simeq3.532\times10^{122}\), while the
Planck base-\(\Lambda\)CDM comparison coordinate is
\(N_\Lambda\simeq3.313\times10^{122}\), a mismatch of about \(6.6\)
percent. On the finite collar branch, declared total reserve expectation
\(P/4\) and six-class equidistribution give presence probability \(P/24\)
for each class. If one class is physically selected, its scalar-weighted
receipt is discharged, and its normalized survival factor acts on global
capacity, it gives
\(N_{\rm pres}=N_{\rm bridge}(1-P/24)\simeq3.2921\times10^{122}\).
The alternative \(N_{\rm bridge}e^{-P/24}\simeq3.3001\times10^{122}\)
...
\(N_\Lambda\simeq3.313\times10^{122}\). The conditional electroweak bridge value
\(N_{\mathrm{EW}}\simeq3.532\times10^{122}\) is about \(6.6\) percent higher.
...
Poisson correction give close retrospective comparison coordinates, but
neither is a physical capacity until the direct source law and both bridges
share a certified carrier.
...
capacity-indexed A1--A3 lift, exact finite-size selector, universe-level
...
The complete capacity-indexed A1--A3 lift and a unique zero are not supplied.
