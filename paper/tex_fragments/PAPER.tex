...
and its canonical longest-parent-chain height. Independently, the exact
...
requires one source-selected spatial placement and refinement family carrying two-way physical
cone/order faithfulness, count--volume calibration, independent dimension/manifoldlikeness and
topology tests, uniqueness control, and smooth curvature convergence.
...
Identifying it with a physical Riemannian bulk or with Lorentzian/Einstein spacetime (via the source-causal continuum certificate of Theorem 4.3e, under its physical-order, refinement, count--volume, manifoldlikeness, topology, and curvature receipts) requires the
...
continuum geometry. It does not derive a physical faithful embedding, a count-to-volume law,
...
injectivity and the converse condition give a faithful finite embedding and
preserve every source interval exactly on the placed image.
...
and ordering fraction rises from \(0.8841\) to \(0.9922\), so this is a
...
and \path{evidence/causet_likeness/verify_causet_likeness_receipt.py}.
