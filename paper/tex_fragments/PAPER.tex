...
reconstruct the current derivative or same-current holonomy. The exact
...
the registered single-recurrence packet. Source derivation of an
order-sensitive matrix current, matter action, complete character category,
and physical Z\textsubscript{6} quotient is work in progress.
