...
The six labeled technical premises used across the OPH papers are introduced up front here so the overview can use them without forcing the reader to hunt for a later table. \textbf{T1} is loop coherence on the ordinary compact-gauge route. \textbf{T2} is the controlled refinement/scaling-limit scope clause for the Lorentz/null-modular/Einstein branch. \textbf{T3} is fixed-cap generalized-entropy stationarity for the Jacobson branch. \textbf{T4}--\textbf{T6} are the bosonic gauge-reconstruction premises: symmetric braiding, a faithful bosonic fiber functor or explicit super-Tannakian fork, and the directed colimit of transportable edge sectors with objectwise finite-dimensional fibers. Section~\ref{14-assumptions-and-external-inputs} states the same list in formal form.
...
\textbf{D5} & Theorem 5.1: Einstein branch & D3+D4 & Jacobson small-ball mathematics; null-to-tensor reconstruction modulo a metric term & T3 together with the locally Lorentzian \(d=4\) scaling regime, the separate interval-preserving projective branch used to transport the D4 half-line identification to bounded intervals, small-ball constancy assumptions, D4 carried remainder negligible at order \(\ell^4\), and the all-directions/all-reference-states premise used in the tensor upgrade & conditional scaling-limit theorem \\
...
\textbf{D5} & Theorem 5.1 rest-frame Einstein relation plus the conditional tensor upgrade of Corollary 5.1 & Jacobson small-ball mathematics; null-to-tensor reconstruction modulo a metric term & fixed-cap stationarity, the locally Lorentzian \(d=4\) scaling regime, the separate interval-preserving projective branch used in the small-ball step, small-ball constancy assumptions, D4 carried remainder negligible at order \(\ell^4\), and the all-directions/all-reference-states premise used in the tensor upgrade & Phase I conditional scaling-limit theorem/corollary \\
