...
selects the \(\mathbb Z_6\) quotient on the declared finite carrier. The
finite local-domain attachment tensors the rank-three screen band with the
generation witness to an exact rank-45 chiral carrier with local signed
operators and an inherited positive finite-domain gap of the signed seam
operator. Laboratory
...
content is not selected by any axiom: the finite rank-45 carrier does not by
itself establish physical families, while scalar multiplicity and extra-sector
completeness lack physical attachments. Each theorem below lists the
...
produces a finite causal complex with \(2{,}304\) events, exact acyclicity,
rank four, and held-out global inertia \((1,3)\). Six closed
...
\(\mathbb F_2\) give lift-ambiguity rank \(3{,}117\). Scalar, chiral, and
...
The exact fifteen-state generation can be tensored with the measured
rank-three screen band on this same domain. The resulting complex rank-\(45\)
finite section space has the recomputed anomaly-free charge table, a
nondegenerate chirality grading, the diagonal \(\mathbb Z_6\) action, and
signed operator \(D_\sigma\otimes I_{45}\). It inherits the zero kernel and
positive finite-domain gap of the signed seam operator with multiplicity
\(45\).
...
identification of the current and flux sectors, rank-45 physical family
attachment, scalar attachment and multiplicity, quantum field realization, and identification of
...
the exact finite rank-45 carrier, equality with the Tannaka group, and quantum
...
a laboratory current. Proposition 4.3ea attaches the canonical rank-three
screen band to the fifteen-state generation on its finite local domain.
Physical identification requires the source-derived matter-pole
identification of that finite rank-45 assembly, continuum Spin/locality,
physical seam selection, residue, excluded-band, and
...
The rank-three band is then unique. The corresponding finite assembly has rank \(45\) after
tensoring with the separately certified rank-15 one-generation packet. These implications are
kernel-decided in the Lean screen certificate.
...
identification of the finite rank-45 carrier, QFT realization, and
