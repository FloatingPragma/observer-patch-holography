...
operators and an inherited positive dimensionless gap. Laboratory
...
positive dimensionless gap with multiplicity \(45\).
...
attachment and multiplicity, rank-45 family attachment, equality with the
Tannaka group, and quantum field realization are work in progress. QED.
...
select that quotient at finite source-model scope. The theorem does not attach a laboratory current
or attach the canonical rank-three screen band to the displayed
three-family matter module. Physical identification requires the source-derived
matter-pole identification of the finite rank-45 screen assembly, Spin/locality, residue, excluded-band, and
...
matter-pole identification, chirality and Spin/locality data, refinement compatibility, and
laboratory attachment. It does not establish the absence of other light sectors.
