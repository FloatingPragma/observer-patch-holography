...
simultaneous reversal interpreted as the conventional overall charge sign.
These facts constrain the response without selecting a Lie bracket. The
...
declared matrix and matter premises. Choosing one response sign and one
projector representative is the conventional charge-conjugation choice.
...
rank-27 residual variety and compact branches remain unclassified. Source
derivation of an order-sensitive matrix current, matter action, complete
character category, and physical Z\textsubscript{6} quotient is work in
progress.
...
Detailed circuits, representative derived summaries, the complete blinded-run receipts, and rerun instructions are public in the \href{https://github.com/FloatingPragma/observer-patch-holography/blob/main/docs/IBM_QUANTUM_CLOUD.md}{engineering write-up} and the accompanying \href{https://github.com/FloatingPragma/observer-patch-holography/tree/main/code/ibm_quantum_cloud}{code and data bundle}.
...
readback on the certified carrier derive \(R=-J\) up to the common
charge-conjugation convention, and the finite certificate derives the
charge-conjugate rank-15 projector pair. Anomaly balance and tensor descent then fix the Standard
Model quotient and \(N_c=3\) from those premises alone. A separately declared one-Higgs scalar attachment gives
