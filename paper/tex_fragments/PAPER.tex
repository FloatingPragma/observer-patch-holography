...
incidence and inverse-port pairing determine \(J\). Under the explicit response-admissibility
contract, the response is one of \(\pm J\), and the finite certificate derives the
...
own declared premises. Physical response source binding,
scalar attachment and multiplicity, physical matter-pole and continuum
