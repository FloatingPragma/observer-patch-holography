...
Here \(P=P_\star\) is the local UV-area ratio selected by the unique root of
that declared outer/inner self-read map. No
measured coupling enters that solve. Its physical Thomson-limit interpretation
requires the same-scheme hadronic spectral transport. A positive global
...
four-vertex punctured complex whose two declared triangular faces have trivial
holonomy while an unfilled loop and its two-arm relative character phase are
nontrivial. Finally, if the loop holonomy factors through a supplied
\(\mathbb Z_n\) sector, every character phase is an \(n\)th root of unity.

\textbf{Scope.} The result is machine checked for supplied finite paths, edge
labels, character, faces, and cyclic-sector factorization. The punctured
control does not claim flatness on undeclared triangles. No theorem here
constructs the connection from observer records or identifies the phase with
a physical gauge flux, spacetime loop, charge, laboratory arm, detector, or
interference fringe.
...
Lorentz overlap cocycle, coordinate displacements transform through its
linear part, their Lorentz intervals are chart independent, and the reverse
transition and triple-overlap laws follow from the same cocycle. Future-null
...
retains source realization of the atlas, population, certified separation,
...
reference deficit \(0.631\) lies inside that certified interval. A source-only bridge requires the OPH
hadron construction. No active blind decision threshold exists for the hadronic bracket.
