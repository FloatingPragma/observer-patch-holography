...
Fixed-cap generalized-entropy stationarity, a uniform small-diamond limit, universal coupling,
...
\end{itemize}
This is the route from null-strip factorization to the Einstein branch, with the half-line generator/charge identification proved inside the null modular bridge itself.
...
\textbf{Lemma E0.5 (Bounded-interval kernel from null projective covariance).} On the null blow-up of the support-visible geometric branch, the half-line generator/charge identity, endpoint-Lipschitz renormalized interval control, and affine/projective covariance give
\[
K_{(a,b)}^{\mathrm{null}}
