...
quotients also carry the local tensors. The proposition does not select the
physical global form, source physical matter typing, attach laboratory
currents, or identify \(G_{\mathrm{packet}}\) with the separately
reconstructed Tannaka group. QED.
...
tensors. The theorem does not select the physical global form, attach a
laboratory current, or attach the canonical rank-three screen band to the
displayed three-family matter module. That promotion requires the
source-derived complex rank-45 attachment,
Spin/locality, residue, excluded-band, and complement-complete refinement
receipts. The gauge proof is Proposition 6.6a, the hypercharge theorem,
