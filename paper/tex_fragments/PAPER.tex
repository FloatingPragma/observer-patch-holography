...
The displayed finite gauge implication uses the incidence, the derived response, and the matter packet, and nothing else. The finite source packet selects the non-split deck cover, odd-Weyl Spin typing, and the \(\mathbb Z_6\) quotient on the declared carrier. Generation and family multiplicity, extra-sector completeness, the charged-lepton branch, and the electroweak quantitative branch carry their own declared premises. Laboratory identification of the current and flux sectors is work in progress.
...
separately declared three-generation completion of the matter packet. Then the completed matter
...
separately declared three-generation completion, the charged-lepton and electroweak quantitative branches, and
