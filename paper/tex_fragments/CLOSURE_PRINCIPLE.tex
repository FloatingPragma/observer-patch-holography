...
branch,
\[
N_0=3.532131543418936\times10^{122},
\]
so the finite-presence candidate is
\(3.292097877326465\times10^{122}\) and the exponential candidate is
\(3.300072225377652\times10^{122}\). The full weighted Planck
base-\(\Lambda\)CDM chain gives the comparison coordinate
\(3.31292709806038\times10^{122}\). The respective residuals are
