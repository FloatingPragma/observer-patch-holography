...
executable-to-Lean bridge are absent. Direct \(N\) is not evaluable on that
incomplete antecedent, and the stronger source-class verdict is open. A
...
named-law branch is not evaluable on this source class, and its horizon
branch has no capacity object. A stronger source-derived action would
