...
\(c\), \(G\), \(W\), \(Z\), and \(H\) is absent. The same calibrated local input \(P\) governs the
...
\(M_W\) & public D10 row \(80.37700001539531~\mathrm{GeV}\); exact sidecar \(80.377~\mathrm{GeV}\) & \(P \rightarrow \alpha_U \rightarrow (t_U,t_{\mathrm{tr}}) \rightarrow v \rightarrow\) D10 repair chart \(\rightarrow M_W\) & exact live promotion lacks one target-free D10 chart-identity theorem \\
...
calibrated input \(P\) organizes the bosonic mass trunk and the gravity-side bridge candidate,
