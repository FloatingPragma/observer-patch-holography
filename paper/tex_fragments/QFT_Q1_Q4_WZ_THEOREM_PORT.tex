...
Slavnov--Taylor controls. It supplies no artifact-resolved complex-ball
\(W/Z\) contour and Laurent packet, dressed-current residue,
independent-\(\xi\) cross-check, or complete identity-control transcript.
Those validation objects are work in progress. The source-selected classical
action, either complete finite quantum object, the OPH matching and current
packet, and the observable tower with continued-sheet data are also work in
progress.
\end{remark}
