\subsubsection*{QFT-Q1--QFT-Q4 implications and the W/Z landing}

The Standard-Model field-theory tiers used here are namespaced to avoid
collision with the separate particle-receipt clauses \((Q1)\)--\((Q3)\).
Their dependency structure is a directed acyclic graph, not an ordinal ladder:
\[
\begin{array}{rcl}
...
& counterterm basis, matching/FJ engines, identities, currents, and numerical freeze
...
descend to an honest representation of \(G_6\), every plaquette term to be a
...
must still produce its regulator-specific restoration transcript and verify
