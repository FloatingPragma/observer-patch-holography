...
strictly positive exact weights \(w_{r,P}\), the realized state is the
information projection. The cover restriction map is injective on
\(\mathcal K_r\), or equivalently at smooth points no nonzero feasible
tangent is invisible to the whole cover:
\[
