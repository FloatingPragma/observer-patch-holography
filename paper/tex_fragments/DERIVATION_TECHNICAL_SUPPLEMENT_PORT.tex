...
adopted axioms. It supplies no faithful isometric completion action,
...
the incomplete source antecedent, and the stronger source-class verdict is
open. A positive cosmic value requires a complete source antecedent, one
