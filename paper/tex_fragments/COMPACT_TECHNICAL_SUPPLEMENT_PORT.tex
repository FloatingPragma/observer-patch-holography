...
The exact-rational calibration table at
\texttt{code/yang\_mills\_gap/manifests/atomic\_4d\_ising\_calibration.json}
...
\begin{remark}[Non-promotion boundary]
...
compact-gauge cylinder algebra on its declared branch. It is not the full
chiral \(G_6\) QFT-Q2 construction, does not by itself instantiate the
Standard-Model QFT-Q4 observable sector, and supplies no resonance-sheet
continuation. Those are separate typed inputs and implications in
Section~\ref{sec:compact-technical-supplement}.
\end{remark}
