...
screen-capacity closure beyond the local null data. The robust closure target is
...
public-section, correctable-code, capacity-bound, approximate-robustness, and
...
scalarization, no-new-confusability extension and refinement packets,
finite-size slack law with one physical zero, and horizon-record saturation
remain open (CL-7).
...
Assume the compact paper's local Einstein branch, robust direct public-record closure and its
capacity coordinate
\[
...
The D6 hypotheses are exactly the D5 local Einstein branch, robust whole-fiber public-record
closure \(\mathfrak F_{r,0}(D_\star)=\{D_\star\}\), horizon-record saturation
...
horizon-record saturation. Conditional on that branch, the capacity closure fixes
...
from D6; the anomalous record attachment and physical CP-odd source generator remain open.
