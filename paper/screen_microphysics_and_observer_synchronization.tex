...
\begin{abstract}
This paper gives OPH a finite microphysical carrier. Observers see finite screen cuts. The model turns those cuts into patch bodies with ports, records, repair channels, and synchronization rules.

The main achievements are regulated patch embedding, the twelve-port screen-sieve theorem, edge-sector weights, central-record Born--L\"uders readout, Bell/CHSH event surfaces with the Tsirelson bound, and checkpoint restoration. The paper also fixes the evidence rule for hardware claims. A run counts as evidence when hashes, manifests, calibration records, and exact verifier receipts are public.
\end{abstract}
