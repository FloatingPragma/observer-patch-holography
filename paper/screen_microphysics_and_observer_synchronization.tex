...
The main achievements are regulated patch embedding, edge-sector weights, central records, Bell/CHSH event surfaces, and checkpoint restoration. The paper also fixes the evidence rule for hardware claims. A run counts as evidence when hashes, manifests, calibration records, and exact verifier receipts are public.
\end{abstract}
