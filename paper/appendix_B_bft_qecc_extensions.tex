...
\begin{enumerate}[(A1)]
  ...
  \item \textbf{Classical exact sizing for this fixed-quorum theorem.}
        ...
        the fault model, but when $n>3f+1$ a fixed $q=2f+1$ quorum no longer
        guarantees the overlap used in the safety proof; one must either
...
\begin{theorem}[QBFT Safety Bound
  {\normalfont\small [Established under A1--A6]}]
