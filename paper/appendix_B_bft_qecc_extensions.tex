...
\paragraph{Sizing and scope boundary.}
...
The finite executable check exhausts all certificate and new-view quorum pairs for
...
\begin{itemize}
  ...
  \item The core OPH consensus paper supplies observable-level confluence and refinement-limit
        normal-form/holonomy classes under their declared premises; the BFT/QECC statements
