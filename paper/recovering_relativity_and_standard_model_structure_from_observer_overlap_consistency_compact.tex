...
The answer depends on which sector is under discussion. In the current public formulation the pixel area $P$ calibrates a separate gauge-coupling sector. Quantities algebraically entangled with that calibration are therefore consistency checks for the implementation rather than part of the recovered-core claim set.
