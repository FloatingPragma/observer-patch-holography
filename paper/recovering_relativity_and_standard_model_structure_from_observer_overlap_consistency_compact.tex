...
\item strong-CP continuations; the current corpus does not derive the bare QCD angle \(\theta_{\mathrm{QCD}}\), the physical anomaly-invariant combination \(\bar\theta\), or a proof that \(\bar\theta=0\);
