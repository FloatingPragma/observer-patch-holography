...
quantity carried by the forward D10 particle-physics map. \(N_{\mathrm{scr}}\) is inferred from
the observed cosmological constant and enters the cosmological-capacity branch. Any retained
capacity-level neutrino side estimate on that input is legacy bookkeeping rather than the live
weighted-cycle theorem lane.
...
implementation on the quantitative-closure branch recorded in the premise ledger. What remains
outside theorem level is a general existence/uniqueness or monotonicity proof for the scalar root
selected by the printed D10 package under arbitrary convention changes.
