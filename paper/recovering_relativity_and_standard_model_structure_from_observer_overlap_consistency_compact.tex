...
low-energy architecture selected by the admissibility conditions used in the gauge branch.
...
\frac{\SU(3)\times\SU(2)\times\U(1)}{\mathbb Z_6}
\]
is recovered on the realized MAR-admissible branch of the bosonic compact-gauge theorem; this is a realized-branch gauge result with explicit matter-package and admissibility premises, not a completed internal fermionic reconstruction theorem.
...
cosmological constant and enters the cosmological-capacity branch. Any retained capacity-level
