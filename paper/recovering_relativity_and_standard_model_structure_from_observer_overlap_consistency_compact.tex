...
t_\Lambda=\frac{r_{\mathrm{dS}}}{c};
\]
\item the observed cosmic age \(t_0\) is not an additional theorem output of this stack and remains a downstream FLRW benchmark.
\end{enumerate}
...
t_\Lambda=\frac{r_{\mathrm{dS}}}{c},
\]
while the observed cosmic age remains a downstream FLRW benchmark rather than an additional D6 theorem output. The compact paper is therefore formulated in a de Sitter-first language: the positive cosmological constant is tied to finite capacity rather than to a deformation of a negative-$\Lambda$ starting point.
...
the Peter--Weyl heat-kernel identity. What remains external is any large-\(N_{\mathrm{edge}}\)
...
two-dimensional Yang--Mills. What remains external is the existence of the large-\(N_{\mathrm{edge}}\)
