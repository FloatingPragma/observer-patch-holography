...
\]
This weighted-cycle branch repairs the oscillation-shape output to the physical PMNS/hierarchy regime on this continuation surface. On that lane the theorem-grade closure is the bridge-rigidity / absolute-attachment pair stated below, while the older positive-segment adapters remain diagnostic-only. It emits
\[
