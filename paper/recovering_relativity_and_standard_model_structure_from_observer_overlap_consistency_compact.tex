...
\frac{\SU(3)\times\SU(2)\times\U(1)}{\mathbb Z_6}
\]
is recovered in the bosonic compact-gauge branch on the realized MAR one-Higgs branch.
...
In the bosonic EFT branch, compact gauge reconstruction follows only after the explicit transportable sector-colimit and the bosonic ordinary/central gauge premises of Assumption~\ref{ass:gaugeprem} are supplied. The genuinely noncentral fixed-cutoff branch is handled separately by crossed-module data rather than by the ordinary compact-group theorem. The realized Standard Model quotient then follows on the same MAR branch. This differs sharply from approaches in which the gauge group is specified in advance.
