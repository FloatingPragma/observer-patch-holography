...
\]
The exact local release burden consists of three explicit objects: one strict classical-regime
clause above the BW/Lorentz honesty package, one target-free D10 chart-identity theorem for exact
\(W/Z\), and one forward Higgs-promotion theorem. On the gravity side,
