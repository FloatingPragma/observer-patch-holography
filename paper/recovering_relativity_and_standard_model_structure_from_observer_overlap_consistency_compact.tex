...
Assume Axioms~\ref{ax:screen}--\ref{ax:entropy}, Theorem~\ref{thm:geosubnet}, the derived fixed-cutoff regulator/collar package established above, and the controlled scaling-limit scope clause \textbf{T1} of Assumption~\ref{ass:technical}. Assume in addition that for each round cap \(C\subset S^2\):
...
The BW/geometric branch is closed at the support-visible regularized level and remains conditional at the unregularized cap-pair level. The unregularized route can be promoted only by proving a noncollapse/common-floor theorem, or by giving a microscopic realization that supplies it. This is the precise content of the \textbf{T1} scaling-limit boundary; it is not a hidden fixed-cutoff exact Lorentz claim.
\end{remark}
