...
In the terminology of the repository file \texttt{CONSISTENCY\_STACK.md}, the quotient
...
with a self-closure target (readback map reduced to the coupling theorem G2-GAP-1; CL-7). Downstream phenomenology requires additional assumptions
