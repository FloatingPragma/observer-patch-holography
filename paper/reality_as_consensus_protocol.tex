...
The coherent observer family and its finite density states are still declared
...
Hilbert-space attachment to the committed tower, not yet a physical QFT;
...
This is an exact coupled two-spin lattice benchmark, not an interacting
quantum field theory and not yet a Hamiltonian attachment to
