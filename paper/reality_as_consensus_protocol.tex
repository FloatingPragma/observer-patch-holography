...
anticommuting pair of units, so a region above a commutative-algebra
region carries no such pair, and full matrix factors above scalar overlaps
are excluded on this interface: the tensor-factor local-algebra picture
with trivial overlap is impossible. The inhabitant locating the boundary
