...
only on their named finite domains; same-source confluence alone does not establish it for an
arbitrary physical boundary map.
\end{remark}
...
\[
  ...
  I_\rho(A:D\mid B).
\]
This does not identify raw CMI with a state-independent local stress source.
