...
current and whose acceptance functionals revalidate remains admissible before newly enabled
...
rule prevents a newly enabled proposal from absorbing either old component before its second
