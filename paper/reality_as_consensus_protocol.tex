...
committed before execution and pins a nonconstant protected record, separate
state and transition tables, an exact recognizer, stationarity, and
contraction. The executed run passed those data-extraction checks. It did not
