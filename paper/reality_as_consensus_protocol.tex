...
(\texttt{leftSlotExpectation\_not\_multiplicative}), and that grade is the
ceiling.  No map from the joint algebra to the record carrier is
...
matrix-factor scalar obstruction.  The boundary is an asymmetry: embedding
at the star-homomorphism grade, projection at the positive unital
trace-preserving expectation grade, and nothing stronger.  Net-to-net and
tower morphism structure at the operator layer stays open.
...
simulates arbitrary circuits or machines with stated encoding overhead and stability under
...
There is no uniform simulation construction, encoding-overhead theorem, or
universality result. The fixed-point theorem classifies quotient normal forms
