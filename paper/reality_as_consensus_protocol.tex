...
formalized results belong to the stack's 111 sorry-free Lean theorems. The paper also explains why
...
with universe-level equation \(N=\log M_0(\mathfrak U_N)\), robust whole-fiber target \(\mathfrak F_{r,0}(D_\star)=\{D_\star\}\), and an independent EW/Higgs comparison bridge. Downstream phenomenology requires additional assumptions
