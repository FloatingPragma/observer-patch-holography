...
Under the declared fermionic Spin category, anomaly-forced determinant
...
extra-sector exclusion require separate identifications. The measured non-split deck
cover forces the odd-Weyl Spin typing, and the measured finite flux-sector
menu selects the \(\mathbb Z_6\) quotient on the declared carrier. Laboratory
