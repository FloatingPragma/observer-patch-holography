...
statement is machine checked for the repository repair map~\cite{ophrepo}.
\end{proof}
...
The record-algebra layer extends upward, in the repository Lean development
\cite{ophrepo}, to a machine-checked interface family in which the observer
...
The registered PR-58 direction is approached in
...
This corrected interface and the triple coupling do not discharge PR-58. They have no multi-step
