...
without the economy axiom. Physical source binding of those contracts,
...
image without the Minimal Admissible Realization (MAR) rule. On this lane, MAR
supplies the economy minimum \(N_g=3\) inside \(3\le N_g\le5\) and the
no-extra-light-sector ordering. Physical matter typing, global-form selection,
...
equilibrium and modular geometry, the exact MAR-free finite Standard Model
gauge implication under explicit response and matter contracts with a
distinct conditional Tannaka reconstruction route, the MAR
economy statements for generation count and extra light sectors, a conditional
