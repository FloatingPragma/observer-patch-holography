...
image from those premises alone. On this branch, the CKM and weak-sector clauses
give the window \(3\le N_g\le5\), and the count inside it together with the
extra-sector statement are declared completions. The measured non-split deck
...
multiplicity remain separate. On the finite local domain, the selected
rank-three band and generation witness form an exact rank-45 chiral carrier
with local signed operators and the inherited positive signed-seam gap.
Physical matter-pole identification, the continuum Spin/locality limit,
physical seam selection, refinement persistence, and laboratory attachment
remain separate.
