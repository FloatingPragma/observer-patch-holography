...
locality for the declared-disjoint regions, and the already committed
...
the selected density state already carried by the tower.  State naturality
makes
\[
  \omega_\xi(\iota_r(X))
...
PR-52 and PR-58 remain open and OL-C6 remains partial.
...
As a separate finite-dimensional test of the Hamiltonian structures still
missing from the completed-net attachment, take
\[
  \mathcal H_{\mathrm I}
...
physical time-slice theorem follows.  PR-15, PR-52, PR-54, and PR-58
therefore remain open, OL-C6 remains partial, and lane~\#743 remains open.
(\path{Lean/QFT/FiniteTwoSiteIsingField.lean}).

\paragraph{The finite Hamiltonian, regional diamond, and selected GNS on one
carrier.}
The two preceding constructions now compose in one typed finite model.  Use
...
still absent.  PR-15, PR-52, PR-54, and PR-58 therefore remain open, OL-C6
remains partial, and lanes~\#730 and~\#743 remain open.
