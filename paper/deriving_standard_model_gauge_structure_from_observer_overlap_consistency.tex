...
admissible ones are registered open premises, and no physical global form is
...
is certificate content, and the source-produced spacetime action stays on
its open register row.
...
spacetime action, and the Spin and physical-chirality attachments stay open
register rows, and no measured coupling, three-family structure, or Yukawa
matrix appears.
