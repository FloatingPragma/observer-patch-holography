...
conditional on any one of three added coordinate repair norms
\(\ell_1,\ell_2,\ell_\infty\), has family \(G\) uniquely nearest among the
classified compact locus. The rule, norms, and minimum-repair law are not
source-derived.
