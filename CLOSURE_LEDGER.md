...
| CL-5 | Forward electroweak emission at SL-3 pixel: (M_W, M_Z) | exact | (80.330, 91.119) vs (80.3692(133), 91.1880(20)) | 4.9×10⁻⁴ / 7.6×10⁻⁴ | 2.9σ / ≈35σ | repair forward chain from the strange-loop principles with preregistered revisions (SLP-06); suspects: frozen MSSM coefficients, QT1–QT5, β_EW. Preregistered revision sweep executed 2026-07-14: of 96 menu entries the single landing is the nonzero-carrier value law at the rounded legacy carrier P = 1.63094 (a counted two-fold selection awaiting independent confirmation), every certified-pixel entry misses, and the SM triple and β_EW ∈ {3, 5} fail structurally (no pixel-residual root / fixed point at 10⁻³ or 10⁶ GeV); falsification/preregistered/ew_repair_results_2026-07-14.json |
...
| CL-7 | Capacity readback map: F(N) = N | exact | F not yet constructed | n/a | n/a | prove the port-load/D10 coupling (G2-GAP-1); declared-structure candidates constructed and excluded 2026-07-14 (`code/capacity_readback/F_CONSTRUCTION_2026-07-14.md`) |
