...
\begin{abstract}
This staged paper owns the OPH cosmological vacuum and structure-formation lane.  It separates
seed noise, conventional reference ensembles, OPH-native quotient ensembles, OPH vacuum claims,
primordial fields, and observable cosmological predictions.  The new result imported here is the
fail-closed vacuum gate: deterministic settlement, repair relaxation, positive transfer existence,
or a visually plausible fluctuating field does not select a physical vacuum.  A vacuum claim
requires source Euclidean slab data, a transfer/reflection-positive reconstruction gate, refinement
compatibility, and simulator receipts.
\end{abstract}

\section{Status}

This is a staged template, not a release-pipeline paper.  It coordinates the vacuum/fluctuation
part of \pathref{cosmology/oph_cosmology_finite_source_cmb_program.tex}, the screen-microphysics
finite carrier, the compact theorem stack, and OPH-FPE simulator outputs in \SimSourceRepo.
