...
source theorem computes canonical source height from authenticated parent
edges and proves strict increase along generated ancestry. Independently, a
...
estimate or physical clock. It does not
supply the smooth metric assumed here. This assumption therefore imports a faithful
manifoldlike refinement, operational clock, count--volume calibration, smooth
curvature, physical stress attachment, and the stated capacity premises on one
common continuum branch.
\end{assumption}
