...
requires the readback map $F$ and its contraction
certificate. The cited branch theorem supplies the other geometry and
capacity premises.
\end{assumption}
...
routes. Finite source instantiation is work in progress. This note consumes
...
conditional radial theorem; finite source receipt is work in progress\\
Kernels &
