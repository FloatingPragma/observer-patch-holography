...
collars. That remainder has no ordinary luminous charge, but it contributes to
the gravitational stress seen by the effective geometry.

This paper develops that idea as a dark-sector branch. In old, settled,
low-acceleration galaxies the correction gives a MOND-like galaxy law and the
baryonic Tully-Fisher scaling. In clusters and cosmology the same source has to
move as transported stress, with its own relaxation, lensing, growth, and
likelihood tests.
\end{abstract}
...
contracts. The paper is a continuation surface; the joint fit is the decisive gate.
...
B. Mueller, A. Osika, M. Poneder, K. Xue, B. Cassie, P. Nguyen, M. A. Visser, K. A. Anirudha, David Matscheko, and J. Hill,
\emph{Observers Are All You Need}, OPH synthesis paper, release \OPHPaperReleaseID,
\OPHPaperReleaseDate.
...
OPH particle paper, release \OPHPaperReleaseID, \OPHPaperReleaseDate.
