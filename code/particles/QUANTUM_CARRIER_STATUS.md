...
| --- | ---: | --- | --- |
| Electromagnetic carrier | `2` | `NOT_EVALUABLE_NO_SOURCE_SELECTED_MAXWELL_QUANTUM_SECTOR` | `source_selected_unbroken_u1_quantum_maxwell_sector`, `finite_source_to_lorentzian_quantum_eft_construction` |
| Color gauge carrier | `16` | `NOT_EVALUABLE_NO_QCD` | `finite_source_to_lorentzian_quantum_eft_construction`, `source_derived_qcd_physical_spectral_sector` |
| Einstein tensor carrier | `2` | `NOT_EVALUABLE_NO_INHABITED_EINSTEIN_QUANTUM_CARRIER` | `inhabited_source_derived_einstein_tower`, `finite_source_to_lorentzian_linearized_quantum_carrier` |
...
Receipt: `sha256:8243d62c1aabffac00988195606037885874356f32f6598ec4ae9830a6c6adee`.
