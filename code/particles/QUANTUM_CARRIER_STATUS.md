...
| Einstein tensor carrier | `2` | `NOT_EVALUABLE_NO_PHYSICAL_SOURCE_CAUSAL_CONTINUUM_OR_QUANTUM_CARRIER` | `source_selected_faithful_3p1_causal_manifold_and_smooth_einstein_limit`, `finite_source_to_lorentzian_linearized_quantum_carrier` |
