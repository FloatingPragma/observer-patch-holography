...
progress (see
the [closure issues](https://github.com/FloatingPragma/observer-patch-holography/issues?q=is%3Aissue+label%3Aclosure)).

The per-family surface with tier labels, explanations, and blocking objects is
[MASS_CANDIDATE_STATUS.md](MASS_CANDIDATE_STATUS.md), generated by
...
- the archived `80.377 GeV`, `91.18797809193725 GeV` pair is a
...
## Electroweak Readout Status (#594)
...
map are absent. The electroweak readout (#594) is not evaluable and is outside the falsification program.
