...
| --- | ---: | --- | --- | --- | --- |
| Higgs Boson | `125.1995304097179 GeV` | `conditional_declared_surface_higgs_top_candidate` | `declared_d10_d11_running_matching_threshold_surface_only` | `False` | `code/particles/runs/calibration/d11_live_exact_split_pair_theorem.json` |
