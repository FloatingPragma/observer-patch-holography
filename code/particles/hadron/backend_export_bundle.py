...
def _normalize_manifest(manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    normalized = {
        ...
        "public_promotion_allowed": manifest.get("public_promotion_allowed", False),
...
def backend_input_from_raw_manifest(
    ...
    *,
    ...
    out: dict[str, Any] = {
        ...
        "execution_class": normalized_manifest.get("execution_class") or "unclassified",
        "claim_tier": normalized_manifest.get("claim_tier"),
        "public_promotion_allowed": normalized_manifest.get("public_promotion_allowed", False),
...
def build_backend_export_skeleton(
    ...
    *,
    ...
    manifest: dict[str, Any] = {
        "artifact": "oph_hadron_backend_raw_export",
        "format_version": 1,
        "execution_class": "production_request_template",
        "claim_tier": "unfilled_backend_export_template",
        ...
        "physics": {
            ...
            "notes": [
                ...
                "This generated template is fail-closed. A backend owner must explicitly replace execution_class, claim_tier, and public_promotion_allowed only after a real run and complete provenance.",
            ],
        },
        "solvers": {},
        "integrator": {},
