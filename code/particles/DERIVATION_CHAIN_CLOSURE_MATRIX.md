...
Reason: Hadron issues #153/#157 are closed out-of-scope pending OPH hadron hardware; the remaining in-scope open P/electroweak chains need a source-emitted residual map and interval certificate before worker audit is meaningful. The charged absolute-anchor, quark global-classification, and direct-top auxiliary-codomain lanes have corpus-limited no-go boundaries.

| Chain | Status | Promotable | Open gates | Outputs | Next artifact |
| --- | --- | --- | --- | --- | --- |
| `p_closure_root` | `candidate_not_certified_root` | `False` | #32, #235, #224 | `P=1.63097210492078846050203640439`, `alpha_inv=136.994020662724205139718642793` | code/P_derivation/runtime/rg_matching_threshold_contract_current.json + code/P_derivation/runtime/thomson_endpoint_package_current.json |
| `structural_massless_bosons` | `closed_structural_zero` | `True` | none | `photon=0.0`, `gluon=0.0`, `graviton=0.0` | none |
| `electroweak_wz` | `compare_only_reproduction_not_prediction_theorem` | `False` | #32, #235, #224 | `w_boson=80.377`, `z_boson=91.18797809193725` | code/P_derivation/runtime/rg_matching_threshold_contract_current.json |
