...
Remaining nonclosed chains: `p_closure_root, electroweak_massive_bosons, higgs_top_declared_surface, selected_class_quarks, neutrino_absolute_attachment`
...
| `hadrons` | `source_backend_absent_empirical_closure_policy_emitted` | `False` | none | n/a | docs/HADRON.md + code/particles/hadron/empirical_ee_hadrons_sources.yaml + code/particles/hadron/empirical_ee_hadronic_spectral_measure.schema.json |
