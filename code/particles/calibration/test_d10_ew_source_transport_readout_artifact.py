...
def test_d10_source_transport_readout_uses_predictive_seed_trial() -> None:
    ...
    assert payload["minimal_conditional_promotion_status"] == "conditional_theorem_plus_unconditional_no_go"
    assert payload["target_emitter_candidate_status"] == "new_theorem_candidate_not_yet_in_corpus"
