...
ROW_CONFIG = {
    ...
    "graviton": {
        ...
        "open_interfaces": [
            {
                "issue": 728,
                "requirement": "a source-selected refinement family with faithful 3+1 causal-manifold convergence",
            },
            {
                "issue": 729,
                "requirement": "same-family causal curvature, stress, and smooth Einstein closure",
            },
            {
                "issue": 635,
                "requirement": "finite-source to Lorentzian quantum-EFT construction",
...
def _boundary_evidence() -> list[dict[str, Any]]:
    ...
    source_causal = _load(SOURCE_CAUSAL_CONTINUUM_PATH)
    ...
    if (
        ...
        raise VerificationError("source-causal physical-continuum boundary changed")
