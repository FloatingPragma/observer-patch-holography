...
Replace supplement-backed one-loop running and threshold conventions with an
explicit EFT matching theorem from the OPH edge sector, including threshold
placement, decoupling, and scheme conversion.
...
- RG matching, thresholds, and scheme conversion are derived from OPH rather
  than imported as background conventions.
- Dependencies, imported premises, and remaining blockers are stated explicitly
