...
- Closable: `True`
- Reason: The row provenance ledger, prospective comparison protocol, and declared convention-sensitivity taxonomy are emitted. Numeric sensitivity intervals remain tied to the populated source spectral measure payload and interval certificate.
