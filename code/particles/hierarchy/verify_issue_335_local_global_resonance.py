...
def main() -> int:
    ...
    cert: dict[str, Any] = {
        ...
        "acceptance_criteria_status": {
            ...
            "honest_residual_definitional_residue_disclosed": True,
            "honest_residual_disclosure": (
