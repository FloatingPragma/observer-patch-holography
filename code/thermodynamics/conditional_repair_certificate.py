...
def open_receipts() -> dict[str, Any]:
    return {
        ...
        "THERMO-REALIZATION": (
            ...
            "properties on the earned sixty-four-k matrix and exhausts the "
            "fifteen syntactic coordinate maps obtained by retaining a "
            "nonempty subset of its four committed fields. Two constant fields "
            ...
            "state. Arbitrary partitions and nonlinear, statistical, "
            "stochastic, weakly lumpable, or history-dependent maps were not "
            "enumerated and are not excluded"
        ),
        "THERMO-ENERGY-CLOCK": (
