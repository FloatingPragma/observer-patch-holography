...
class MatterMenuSpectralLedgerTests(unittest.TestCase):
    ...
    def test_pinned_matter_lift_values(self) -> None:
        ...
        self.assertTrue(pinned_block["checks"]["conditional_fixture_only"])
        self.assertTrue(pinned_block["checks"]["physical_source_gate_closed"])
        self.assertTrue(self.pinned["conditional_algebraic_gate_passed"])
        self.assertFalse(self.pinned["physical_source_gate_passed"])
