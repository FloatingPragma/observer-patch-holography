...
payload = {
    ...
    "theorem_scope": {
        ...
        "exact_companion_constructions": [
            ...
            "declared six-axis relation-lattice quotient isomorphic to Z6",
        ],
        "physical_gates": [
            "A1 declares the local unlabeled icosahedral boundary packet. The Echosahedral selector certificate derives its finite counting, pairing, frame, and refinement statements only on the richer declared quotient-visible carrier lineage; the response law and physical carrier identification remain separate",
            "PORT-CURRENT-INNER verifies the exact charged-double-triplet matrices as a declared witness of the forced abstract Lie type. The semantic response artifact independently fixes the response operator, relative sector signs, oriented frame, and persistence maps; it does not reconstruct the matrix generators, their bracket, or same-current overlap holonomy. Source realization and laboratory attachment remain open",
            "the super-Tannakian matter lift verifies exact cover, exterior-algebra, anomaly, Yukawa-admissibility, scalar-menu, and channel statements inside the declared current and matter fixtures. Its refinement maps are conditionally intertwined with the bound response artifact; source selection of the physical matter action and a same-source current-to-matter bridge remain open",
            "AXIS-CENTER-DESCENT computes the common kernel and maximal faithful quotient for the declared charge tables and declared coefficient system. It does not select the physical global form or identify that axis system with a source-realized current and matter action; BLOCK-DETERMINANT-BALANCE is derived only inside the declared matter packet",
            "matter-menu completeness and family attachment remain in their own lanes",
        ],
    },
    "claim_boundary": {
        "proved_here": "finite A5 arithmetic and conditional coefficient-algebra classification",
        "work_in_progress": [
            "source reconstruction of the current generators, bracket, and same-current holonomy",
            "source selection of the matter action and physical global quotient",
