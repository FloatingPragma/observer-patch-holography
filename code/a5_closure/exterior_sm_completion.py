...
payload = {
    ...
    "conditional_closure": {
        ...
        "remaining_producers": [
            ...
            "PORT-CURRENT-INNER is closed on the declared response branch (port_current_inner_certificate.py); deriving its response scales and odd sign from raw consensus dynamics remains open",
