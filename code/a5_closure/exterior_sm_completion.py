...
payload = {
    ...
    "conditional_closure": {
        ...
        "remaining_producers": [
            ...
            "PORT-SPIN-LIFT: super_tannakian_matter_lift_certificate.py verifies the conditional algebraic matter lift (non-split double cover, projector-realized fifteen-state module, kernel emission, and a nonempty declared candidate class); the physical #314 source-realization gate remains open pending #599, source binding of the matter contract, menu completeness, and physical refinement maps",
