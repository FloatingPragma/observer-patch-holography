...
payload = {
    ...
    "conditional_closure": {
        ...
        "remaining_producers": [
            ...
            "PORT-CURRENT-INNER is closed conditionally on the declared response branch (port_current_inner_certificate.py); the response packet is a typed branch premise and its physical measurement, plus deriving the scales and odd sign from raw consensus dynamics, remains open",
