...
declared matter-lift contracts, meeting the #314 acceptance criteria: the
...
- **PORT-SPIN-LIFT (physical source binding)**: land the exact algebraic
  ...
  conditional #566 premises and meets the #314 acceptance criteria; the
  physical receipt inherits the #599 premise binding.
