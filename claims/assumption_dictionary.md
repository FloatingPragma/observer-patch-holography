...
| `finite_or_pairwise_summable_product_channel_family` | A weighted \(\ell^p\) product pseudometric uses a finite declared channel set, or its weighted \(p\)-sum is finite for every compared pair. | Consensus and compact papers |
