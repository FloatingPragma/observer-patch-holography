...
- **[Theoretical Bounds on $\chi_\nu$ in Observer-Patch Holography](extra/chi_nu_susceptibility_bounds.pdf)**: OPH-derived continuation-window bounds, with macroscopic response thresholds near $10^{-22}$ to $10^{-24}$.
