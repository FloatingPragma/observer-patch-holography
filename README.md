...
observer-facing illusions: stable effective appearances generated by deeper
patch consistency. The rest of this README gives the mathematical proof stack
and empirical verification surface.
...
- **Calibration note. [Digital Calibration Note for OPH Screen Microphysics](paper/screen_microphysics_digital_calibration_note.pdf)**: the octahedral \(\mathbb Z_2/S_3\) simulator suite, scoped as digital calibration for patch constraints. No literal spherical substrate model is claimed.
