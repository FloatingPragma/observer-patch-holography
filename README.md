...
The electroweak calculation keeps three numerical objects separate. The exact
selected-carrier chart gives
$(m_W,m_Z)=(80.3862916924,91.1829044467)$ GeV. An archived value law gives
$(80.3770000154,91.1879780779)$ GeV as an exact implication of the five finite
quotient-transport premises QT1--QT5, whose carrier certificate is not emitted.
A frozen adapter gives $(80.377,91.1879780919)$ GeV for comparison only. None
of these objects is a physical complex-pole theorem.

The color-balanced quadratic model, with proposed weights
$\sqrt{N_c}/2$ and $N_c$, is a distinct alternative to the complete
quotient-transport law. Numerical agreement does not select between them. The clean source-side
result is the dimensionless hierarchy $v/E_\star$ on each named pixel branch;
an independent physical $E_\star$ is required before that ratio becomes a mass
in GeV. The D11 Higgs coordinate is conditional on the declared downstream
running, matching, and threshold surface. A source-closed boson mass triple
also requires one strict source root, a derived quotient-transport certificate,
a frozen scheme packet, branch rigidity, prospective provenance, and
complex-pole and uncertainty receipts.
...
| Fine-structure (inv) | $\alpha^{-1}$ | source-audit branch witness 136.99483516462165, not yet a full endpoint fixed-point proof; empirical-closure endpoint 136.264 on [136.158, 136.369] | 137.035999177(21) | the strict source branch still needs the Ward-projected self-map interval proof; the empirical endpoint uses a measured $e^+e^-\to$ hadrons compilation, and its gap to the measured value is the same-scheme anchor gap [0.649, 0.855] |
| Higgs boson | $m_H$ | conditional D11 downstream coordinate 125.1995304097 GeV on the declared running, matching, and threshold surface | 125.20 ± 0.11 GeV | inherits the source-root, physical-scale, quotient-transport, scheme, rigidity, provenance, uncertainty, and complex-pole gates |
| Top quark | $m_t$ | companion coordinate 172.3523553288 GeV on the same conditional surface | 172.1 ± 0.6 GeV | not a separate public top-mass prediction row |
| W boson | $m_W$ | selected carrier 80.3862916924 GeV; archived QT1--QT5 value-law candidate 80.3770000154 GeV; frozen adapter 80.377 GeV | 80.3692 ± 0.0133 GeV | exact chart, conditional implication, and comparison adapter respectively; no pole-mass row promoted |
| Z boson | $m_Z$ | selected carrier 91.1829044467 GeV; archived QT1--QT5 value-law candidate 91.1879780779 GeV; frozen adapter 91.1879780919 GeV | 91.1876 ± 0.0021 GeV | exact chart, conditional implication, and comparison adapter respectively; no pole-mass row promoted |
| Charged leptons | $m_e, m_\mu, m_\tau$ | frozen Stage-5 legacy-branch postdiction: 0.510882243295 MeV, 105.635282871 MeV, 1776.579124017 MeV. A separate target-informed icosahedral face-incidence candidate gives 0.510998950843394 MeV, 105.658375501481 MeV, 1776.930000014351 MeV on one hybrid branch | 0.51099895069 MeV, 105.6583755 MeV, 1776.93 MeV | the exact $A_5/C_3$ face geometry is derived. The declared repair map is conditionally contractive with one fixed point, but source-multiplier witnesses leave it unselected. The 0.000300-ppm headline uses rounded fields; the tau residual is -1.387289 ppm against the packet's higher-precision central value. Physical attachment, phase/determinant source laws, coherent branch, refinement, and pole scheme remain open; this is not a promoted prediction |
| Quark mass spectrum | $m_q$ | source equations leave two independent positive spread moduli; withheld as one group | six measured running masses in various schemes | exact finite-algebra lemmas, a target-informed 0.2946% template diagnostic, and a later 0.29436% RSCC candidate. RSCC removes five direct legacy decimals but replaces them with an unproved target-informed module/rank/sign/cumulant ledger; all F1--F6 receipts remain open, its simpler ablation fits the same mixed table better, and neither diagnostic is a physical postdiction |
...
- **Paper 3. [Deriving the Particle Zoo from Observer Consistency](paper/deriving_the_particle_zoo_from_observer_consistency.pdf)**: particle-sector derivation and audit surface. It carries the $P_\star$-driven reconstruction, conditional action-level carrier modes with open quantum-particle gates, the Borel-Weil one-Higgs carrier bridge, electroweak/Higgs/top, quark, charged-lepton, neutrino, and hadron lanes, quantitative benchmark checks, and conditional record-worldline stitching. Its electroweak ledger separates the exact selected-carrier chart, the archived value law that follows from QT1--QT5, and the frozen comparison adapter. The finite-carrier QT certificate is not emitted. The color-balanced amplitude/loop model is a distinct alternative rather than the complete QT law, and the Higgs coordinate remains conditional on its declared downstream surface. The paper also records the empirical $e^+e^-\to$ hadrons fine-structure endpoint. In the quark lane, the source equations leave a free $(\mathbb R_{>0})^2$ spread fiber. MAR assigns every positive rescaling in that fiber the same structural score because its complexity vector contains no Yukawa eigenvalue. The exact S3 heat, centered-plane, closed-ray, and conditional normalized-trace lemmas are recorded. A target-informed two-mode evaluator reaches a 0.2946% maximum residual against the mixed comparison chart, but it consumes handwritten-template descendants and a Stage-5-dependent pixel branch. The later RSCC candidate removes those five direct template decimals from the leaf evaluator and gives a 0.29436% residual after declaring a target-informed finite-module/effect/sign ledger. It does not derive that ledger, Gaussian truncation, the inherited affine laws, a coherent scale, or an RG packet; the same lower-order scaffold without the RSCC quadratic corrections fits the retrospective table better. Both are quarantined formula-discovery diagnostics, not physical quark-mass postdictions, so numeric quark rows remain withheld. The charged-lepton lane records the frozen Stage-5 postdiction and the exact icosahedral face-corner carrier theorem. A near-exact face-incidence continuation is retained as a target-informed completion conjecture, with its repair laws and branch provenance kept outside the theorem surface. The older electromagnetic interval inversion remains target-containing comparison only. The derivation of the physical neutrino mixing matrix and absolute neutrino masses is work in progress.
