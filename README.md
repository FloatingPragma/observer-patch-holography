...
| Charged leptons | $m_e, m_\mu, m_\tau$ | frozen Stage-5 legacy-branch postdiction: 0.510882243295 MeV, 105.635282871 MeV, 1776.579124017 MeV | 0.51099895069 MeV, 105.6583755 MeV, 1776.93 MeV | maximum error 0.02284% at legacy $P=1.63094$; 0.08347% on the current public-pixel probe. The balanced carrier, $2/9$ phase, determinant normalization, family attachment, and pole-mass scheme bridge are not OPH-derived; this is not a promoted prediction |
