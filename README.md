...
local/global hierarchy package. On that selected exact branch, OPH solves the
electroweak hierarchy/naturality problem with $\epsilon_H=0$ and no measured
weak-scale input. The detailed formulas and claim tiers live in the papers.
