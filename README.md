...
form and identifies the Yang-Mills mass gap with the repair gap. Clay-facing
status depends on accepting that OPH branch as a four-dimensional axiomatic
...
- **Three-body OPH demo:** [3body.floatingpragma.io](https://3body.floatingpragma.io): an extra simulator and proof walk-through for the OPH finite patch-net formulation of the three-body problem, framed as a loop-holonomy gluing example. It is not a closed-form elementary solution.
